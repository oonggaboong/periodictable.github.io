...
THREE.Quaternion.prototype = {
  ...
  setFromEuler: function (a, b) {
    var c = Math.cos(a.x / 2),
      ...
      g = Math.sin(a.z / 2);
    void 0 === b || "XYZ" === b
      ? ((this.x = f * d * e + c * h * g), (this.y = c * h * e - f * d * g), (this.z = c * d * g + f * h * e), (this.w = c * d * e - f * h * g))
      : "YXZ" === b
      ? ((this.x = f * d * e + c * h * g), (this.y = c * h * e - f * d * g), (this.z = c * d * g - f * h * e), (this.w = c * d * e + f * h * g))
      : "ZXY" === b
      ? ((this.x = f * d * e - c * h * g), (this.y = c * h * e + f * d * g), (this.z = c * d * g + f * h * e), (this.w = c * d * e - f * h * g))
      ...
      : "YZX" === b
      ? ((this.x = f * d * e + c * h * g), (this.y = c * h * e + f * d * g), (this.z = c * d * g - f * h * e), (this.w = c * d * e - f * h * g))
      : "XZY" === b && ((this.x = f * d * e - c * h * g), (this.y = c * h * e - f * d * g), (this.z = c * d * g + f * h * e), (this.w = c * d * e + f * h * g));
    return this;
  },
  ...
  setFromRotationMatrix: function (a) {
    var b = a.elements,
      ...
      j = c + f + b;
    0 < j
      ? ((c = 0.5 / Math.sqrt(j + 1)), (this.w = 0.25 / c), (this.x = (i - h) * c), (this.y = (d - g) * c), (this.z = (e - a) * c))
      : c > f && c > b
      ? ((c = 2 * Math.sqrt(1 + c - f - b)), (this.w = (i - h) / c), (this.x = 0.25 * c), (this.y = (a + e) / c), (this.z = (d + g) / c))
      : f > b
      ? ((c = 2 * Math.sqrt(1 + f - c - b)), (this.w = (d - g) / c), (this.x = (a + e) / c), (this.y = 0.25 * c), (this.z = (h + i) / c))
      : ((c = 2 * Math.sqrt(1 + b - c - f)), (this.w = (e - a) / c), (this.x = (d + g) / c), (this.y = (h + i) / c), (this.z = 0.25 * c));
    return this;
  },
  inverse: function () {
  ...
  slerp: function (a, b) {
    ...
    0 > h ? ((this.w = -a.w), (this.x = -a.x), (this.y = -a.y), (this.z = -a.z), (h = -h)) : this.copy(a);
    if (1 <= h) return (this.w = f), (this.x = c), (this.y = d), (this.z = e), this;
    var g = Math.acos(h),
      i = Math.sqrt(1 - h * h);
...
THREE.Vector3.prototype = {
  ...
  setEulerFromRotationMatrix: function (a, b) {
    ...
    var d = a.elements,
      ...
      d = d[10];
    void 0 === b || "XYZ" === b
      ? ((this.y = Math.asin(c(h))), 0.99999 > Math.abs(h) ? ((this.x = Math.atan2(-j, d)), (this.z = Math.atan2(-f, e))) : ((this.x = Math.atan2(n, i)), (this.z = 0)))
      : "YXZ" === b
      ? ((this.x = Math.asin(-c(j))), 0.99999 > Math.abs(j) ? ((this.y = Math.atan2(h, d)), (this.z = Math.atan2(g, i))) : ((this.y = Math.atan2(-l, e)), (this.z = 0)))
      : "ZXY" === b
      ? ((this.x = Math.asin(c(n))), 0.99999 > Math.abs(n) ? ((this.y = Math.atan2(-l, d)), (this.z = Math.atan2(-f, i))) : ((this.y = 0), (this.z = Math.atan2(g, e))))
      : "ZYX" === b
      ? ((this.y = Math.asin(-c(l))), 0.99999 > Math.abs(l) ? ((this.x = Math.atan2(n, d)), (this.z = Math.atan2(g, e))) : ((this.x = 0), (this.z = Math.atan2(-f, i))))
      : "YZX" === b
      ? ((this.z = Math.asin(c(g))), 0.99999 > Math.abs(g) ? ((this.x = Math.atan2(-j, i)), (this.y = Math.atan2(-l, e))) : ((this.x = 0), (this.y = Math.atan2(h, d))))
      : "XZY" === b && ((this.z = Math.asin(-c(f))), 0.99999 > Math.abs(f) ? ((this.x = Math.atan2(n, i)), (this.y = Math.atan2(h, e))) : ((this.x = Math.atan2(-j, d)), (this.y = 0)));
    return this;
  },
  setEulerFromQuaternion: function (a, b) {
    ...
    var d = a.x * a.x,
      ...
      h = a.w * a.w;
    void 0 === b || "XYZ" === b
      ? ((this.x = Math.atan2(2 * (a.x * a.w - a.y * a.z), h - d - e + f)), (this.y = Math.asin(c(2 * (a.x * a.z + a.y * a.w)))), (this.z = Math.atan2(2 * (a.z * a.w - a.x * a.y), h + d - e - f)))
      : "YXZ" === b
      ? ((this.x = Math.asin(c(2 * (a.x * a.w - a.y * a.z)))), (this.y = Math.atan2(2 * (a.x * a.z + a.y * a.w), h - d - e + f)), (this.z = Math.atan2(2 * (a.x * a.y + a.z * a.w), h - d + e - f)))
      : "ZXY" === b
      ? ((this.x = Math.asin(c(2 * (a.x * a.w + a.y * a.z)))), (this.y = Math.atan2(2 * (a.y * a.w - a.z * a.x), h - d - e + f)), (this.z = Math.atan2(2 * (a.z * a.w - a.x * a.y), h - d + e - f)))
      : "ZYX" === b
      ? ((this.x = Math.atan2(2 * (a.x * a.w + a.z * a.y), h - d - e + f)), (this.y = Math.asin(c(2 * (a.y * a.w - a.x * a.z)))), (this.z = Math.atan2(2 * (a.x * a.y + a.z * a.w), h + d - e - f)))
      : "YZX" === b
      ? ((this.x = Math.atan2(2 * (a.x * a.w - a.z * a.y), h - d + e - f)), (this.y = Math.atan2(2 * (a.y * a.w - a.x * a.z), h + d - e - f)), (this.z = Math.asin(c(2 * (a.x * a.y + a.z * a.w)))))
      : "XZY" === b && ((this.x = Math.atan2(2 * (a.x * a.w + a.y * a.z), h - d + e - f)), (this.y = Math.atan2(2 * (a.x * a.z + a.y * a.w), h + d - e - f)), (this.z = Math.asin(c(2 * (a.z * a.w - a.x * a.y)))));
    return this;
  },
...
THREE.Matrix4 = function (a, b, c, d, e, f, h, g, i, j, l, n, m, q, t, r) {
...
THREE.Matrix4.prototype = {
  ...
  set: function (a, b, c, d, e, f, h, g, i, j, l, n, m, q, t, r) {
    var p = this.elements;
    p[0] = a;
    p[4] = b;
    p[8] = c;
  ...
  makeRotationFromEuler: function (a, b) {
    ...
    if (void 0 === b || "XYZ" === b) {
      ...
      "YXZ" === b
        ? ((j = g * i), (l = g * f), (n = e * i), (m = e * f), (c[0] = j + m * d), (c[4] = n * d - l), (c[8] = h * e), (c[1] = h * f), (c[5] = h * i), (c[9] = -d), (c[2] = l * d - n), (c[6] = m + j * d), (c[10] = h * g))
        : "ZXY" === b
        ? ((j = g * i), (l = g * f), (n = e * i), (m = e * f), (c[0] = j - m * d), (c[4] = -h * f), (c[8] = n + l * d), (c[1] = l + n * d), (c[5] = h * i), (c[9] = m - j * d), (c[2] = -h * e), (c[6] = d), (c[10] = h * g))
        : "ZYX" === b
        ? ((j = h * i), (l = h * f), (n = d * i), (m = d * f), (c[0] = g * i), (c[4] = n * e - l), (c[8] = j * e + m), (c[1] = g * f), (c[5] = m * e + j), (c[9] = l * e - n), (c[2] = -e), (c[6] = d * g), (c[10] = h * g))
        : "YZX" === b
        ? ((j = h * g), (l = h * e), (n = d * g), (m = d * e), (c[0] = g * i), (c[4] = m - j * f), (c[8] = n * f + l), (c[1] = f), (c[5] = h * i), (c[9] = -d * i), (c[2] = -e * i), (c[6] = l * f + n), (c[10] = j - m * f))
        : "XZY" === b && ((j = h * g), (l = h * e), (n = d * g), (m = d * e), (c[0] = g * i), (c[4] = -f), (c[8] = e * i), (c[1] = j * f + m), (c[5] = h * i), (c[9] = l * f - n), (c[2] = n * f - l), (c[6] = d * i), (c[10] = m * f + j));
    c[3] = 0;
    c[7] = 0;
    c[11] = 0;
    c[12] = 0;
  ...
  multiplyMatrices: function (a, b) {
    ...
    e[4] = f * H + h * B + g * N + i * Z;
    e[8] = f * I + h * L + g * z + i * K;
    e[12] = f * F + h * C + g * M + i * d;
    e[1] = j * G + l * A + n * J + m * w;
    e[5] = j * H + l * B + n * N + m * Z;
    e[9] = j * I + l * L + n * z + m * K;
    e[13] = j * F + l * C + n * M + m * d;
    e[2] = q * G + t * A + r * J + p * w;
    e[6] = q * H + t * B + r * N + p * Z;
    e[10] = q * I + t * L + r * z + p * K;
    e[14] = q * F + t * C + r * M + p * d;
    e[3] = s * G + v * A + y * J + c * w;
    e[7] = s * H + v * B + y * N + c * Z;
    e[11] = s * I + v * L + y * z + c * K;
    e[15] = s * F + v * C + y * M + c * d;
    return this;
  },
  ...
  determinant: function () {
    var a = this.elements,
      ...
      m = a[14];
    return (
      a[3] * (+e * g * l - d * i * l - e * h * n + c * i * n + d * h * m - c * g * m) +
      a[7] * (+b * g * m - b * i * n + e * f * n - d * f * m + d * i * j - e * g * j) +
      a[11] * (+b * i * l - b * h * m - e * f * l + c * f * m + e * h * j - c * i * j) +
      a[15] * (-d * h * j - b * g * l + b * h * n + d * f * l - c * f * n + c * g * j)
    );
  },
  transpose: function () {
    var a = this.elements,
  ...
  getInverse: function (a, b) {
    var c = this.elements,
      ...
      v = d[11],
      y = d[15];
    c[0] = l * r * s - n * t * s + n * q * v - j * r * v - l * q * y + j * t * y;
    c[4] = g * t * s - h * r * s - g * q * v + f * r * v + h * q * y - f * t * y;
    c[8] = h * n * s - g * l * s + g * j * v - f * n * v - h * j * y + f * l * y;
    c[12] = g * l * q - h * n * q - g * j * t + f * n * t + h * j * r - f * l * r;
    c[1] = n * t * p - l * r * p - n * m * v + i * r * v + l * m * y - i * t * y;
    c[5] = h * r * p - g * t * p + g * m * v - e * r * v - h * m * y + e * t * y;
    c[9] = g * l * p - h * n * p - g * i * v + e * n * v + h * i * y - e * l * y;
    c[13] = h * n * m - g * l * m + g * i * t - e * n * t - h * i * r + e * l * r;
    c[2] = j * r * p - n * q * p + n * m * s - i * r * s - j * m * y + i * q * y;
    c[6] = g * q * p - f * r * p - g * m * s + e * r * s + f * m * y - e * q * y;
    c[10] = f * n * p - g * j * p + g * i * s - e * n * s - f * i * y + e * j * y;
    c[14] = g * j * m - f * n * m - g * i * q + e * n * q + f * i * r - e * j * r;
    c[3] = l * q * p - j * t * p - l * m * s + i * t * s + j * m * v - i * q * v;
    c[7] = f * t * p - h * q * p + h * m * s - e * t * s - f * m * v + e * q * v;
    c[11] = h * j * p - f * l * p - h * i * s + e * l * s + f * i * v - e * j * v;
    c[15] = f * l * m - h * j * m + h * i * q - e * l * q - f * i * t + e * j * t;
...
THREE.Frustum.prototype = {
  ...
  setFromMatrix: function (a) {
    ...
    b[2].setComponents(f + d, j + g, q + n, c + r).normalize();
    b[3].setComponents(f - d, j - g, q - n, c - r).normalize();
    b[4].setComponents(f - e, j - i, q - m, c - p).normalize();
    b[5].setComponents(f + e, j + i, q + m, c + p).normalize();
    return this;
  },
...
(function (a) {
  ...
  var b = new a.Sphere(),
    ...
    i = function (g, j, m) {
      ...
      } else if (g instanceof a.LOD) f.getPositionFromMatrix(g.matrixWorld), (q = j.ray.origin.distanceTo(f)), i(g.getObjectForDistance(q), j, m);
      else if (g instanceof a.Mesh) {
        f.getPositionFromMatrix(g.matrixWorld);
        b.set(f, g.geometry.boundingSphere.radius * g.matrixWorld.getMaxScaleOnAxis());
        if (!1 === j.ray.isIntersectionSphere(b)) return m;
        var q = g.geometry,
          t = q.vertices;
        if (q instanceof a.BufferGeometry) {
          var r = g.material instanceof a.MeshFaceMaterial,
            p = !0 === r ? g.material.materials : null,
            s = g.material.side,
            v,
            y,
            G,
          ...
          if (!q.dynamic) return m;
          var I,
            t = !1;
          q.attributes.index ? ((t = !0), (I = q.attributes.index.numItems / 3)) : (I = q.attributes.position.numItems / 9);
          for (var F = 0; F < I; F++) {
            t ? ((v = q.attributes.index.array[3 * F]), (y = q.attributes.index.array[3 * F + 1]), (G = q.attributes.index.array[3 * F + 2])) : ((v = 3 * F), (y = 3 * F + 1), (G = 3 * F + 2));
            var A = [q.attributes.position.array[3 * v], q.attributes.position.array[3 * v + 1], q.attributes.position.array[3 * v + 2]],
              r = [q.attributes.position.array[3 * y], q.attributes.position.array[3 * y + 1], q.attributes.position.array[3 * y + 2]],
              p = [q.attributes.position.array[3 * G], q.attributes.position.array[3 * G + 1], q.attributes.position.array[3 * G + 2]],
              s = g.material;
            if (void 0 !== s) {
              var B = new a.Vector3(),
                L = new a.Vector3(),
                A = new a.Vector3(A[0], A[1], A[2]),
                r = new a.Vector3(r[0], r[1], r[2]),
                p = new a.Vector3(p[0], p[1], p[2]);
              B.subVectors(p, r);
              L.subVectors(A, r);
              B.cross(L);
              B.normalize();
              d.setFromNormalAndCoplanarPoint(B, A);
              B = c.distanceToPlane(d);
              if (!(Math.abs(B) < H) && !(0 > B)) {
                s = s.side;
                if (s !== a.DoubleSide && ((L = c.direction.dot(d.normal)), !(s === a.FrontSide ? 0 > L : 0 < L))) continue;
                B < j.near ||
                  B > j.far ||
                  ((e = c.at(B, e)),
                  a.Triangle.containsPoint(e, A, r, p) &&
                    ((A = new a.Face3(v, y, G)),
                    (s = q.attributes.color.array),
                    (A.vertexColors[0] = new a.Color(s[3 * v], s[3 * v + 1], s[3 * v + 2])),
                    (A.vertexColors[1] = new a.Color(s[3 * y], s[3 * y + 1], s[3 * y + 2])),
                    (A.vertexColors[2] = new a.Color(s[3 * G], s[3 * G + 1], s[3 * G + 2])),
                    m.push({ distance: B, point: j.ray.at(B), face: A, faceIndex: F, object: g })));
              }
            }
          }
          ...
          c.copy(j.ray).applyMatrix4(h);
          F = 0;
          for (I = q.faces.length; F < I; F++)
            if (((A = q.faces[F]), (s = !0 === r ? p[A.materialIndex] : g.material), void 0 !== s && (d.setFromNormalAndCoplanarPoint(A.normal, t[A.a]), (B = c.distanceToPlane(d)), !(Math.abs(B) < H) && !(0 > B)))) {
              s = s.side;
              if (s !== a.DoubleSide && ((L = c.direction.dot(d.normal)), !(s === a.FrontSide ? 0 > L : 0 < L))) continue;
              if (!(B < j.near || B > j.far)) {
                e = c.at(B, e);
                if (A instanceof a.Face3) {
                  if (((v = t[A.a]), (y = t[A.b]), (G = t[A.c]), !a.Triangle.containsPoint(e, v, y, G))) continue;
                } else if (A instanceof a.Face4) {
                  if (((v = t[A.a]), (y = t[A.b]), (G = t[A.c]), (s = t[A.d]), !a.Triangle.containsPoint(e, v, y, s) && !a.Triangle.containsPoint(e, y, G, s))) continue;
...
THREE.Projector = function () {
  ...
  var d,
    ...
    A = [],
    B = 0,
    L = { objects: [], sprites: [], lights: [], elements: [] },
    C = new THREE.Vector3(),
    J = new THREE.Vector4(),
  ...
  var V = function (a) {
      ...
      d.object = a;
      null !== a.renderDepth ? (d.z = a.renderDepth) : (C.getPositionFromMatrix(a.matrixWorld), C.applyProjection(K), (d.z = C.z));
      return d;
    },
    ea = function (a) {
      if (!1 !== a.visible) {
        a instanceof THREE.Light ? L.lights.push(a) : a instanceof THREE.Mesh || a instanceof THREE.Line ? (!1 === a.frustumCulled || !0 === Fa.intersectsObject(a)) && L.objects.push(V(a)) : (a instanceof THREE.Sprite || a instanceof THREE.Particle) && L.sprites.push(V(a));
  ...
  this.projectScene = function (d, f, h, l) {
    ...
    K.multiplyMatrices(f.projectionMatrix, Z);
    O.getNormalMatrix(Z);
    Fa.setFromMatrix(K);
    e = 0;
    L.objects.length = 0;
    ...
    L.lights.length = 0;
    ea(d);
    !0 === h && L.objects.sort(b);
    d = 0;
    for (h = L.objects.length; d < h; d++)
      if (((ma = L.objects[d].object), (oa = ma.matrixWorld), (i = 0), ma instanceof THREE.Mesh)) {
        xa = ma.geometry;
        da = xa.vertices;
        bb = xa.faces;
        xa = xa.faceVertexUvs;
        ...
        C = 0;
        for (fa = da.length; C < fa; C++)
          (g = a()),
            g.positionWorld.copy(da[C]).applyMatrix4(oa),
        ...
        da = 0;
        for (C = bb.length; da < C; da++) {
          fa = bb[da];
          var ka = !0 === ha ? ra.materials[fa.materialIndex] : ma.material;
          if (void 0 !== ka) {
            la = ka.side;
            if (fa instanceof THREE.Face3)
              if (((T = j[fa.a]), (aa = j[fa.b]), (Y = j[fa.c]), (M[0] = T.positionScreen), (M[1] = aa.positionScreen), (M[2] = Y.positionScreen), !0 === T.visible || !0 === aa.visible || !0 === Y.visible || N.isIntersectionBox(z.setFromPoints(M))))
                if (((V = 0 > (Y.positionScreen.x - T.positionScreen.x) * (aa.positionScreen.y - T.positionScreen.y) - (Y.positionScreen.y - T.positionScreen.y) * (aa.positionScreen.x - T.positionScreen.x)), la === THREE.DoubleSide || V === (la === THREE.FrontSide)))
                  m === t ? ((ia = new THREE.RenderableFace3()), q.push(ia), t++, m++, (n = ia)) : (n = q[m++]), n.v1.copy(T), n.v2.copy(aa), n.v3.copy(Y);
                else continue;
              else continue;
            else if (fa instanceof THREE.Face4)
              if (((T = j[fa.a]), (aa = j[fa.b]), (Y = j[fa.c]), (ia = j[fa.d]), (w[0] = T.positionScreen), (w[1] = aa.positionScreen), (w[2] = Y.positionScreen), (w[3] = ia.positionScreen), !0 === T.visible || !0 === aa.visible || !0 === Y.visible || !0 === ia.visible || N.isIntersectionBox(z.setFromPoints(w))))
                if (
                  ((V =
                    0 > (ia.positionScreen.x - T.positionScreen.x) * (aa.positionScreen.y - T.positionScreen.y) - (ia.positionScreen.y - T.positionScreen.y) * (aa.positionScreen.x - T.positionScreen.x) ||
                    0 > (aa.positionScreen.x - Y.positionScreen.x) * (ia.positionScreen.y - Y.positionScreen.y) - (aa.positionScreen.y - Y.positionScreen.y) * (ia.positionScreen.x - Y.positionScreen.x)),
            ...
            !1 === V && (la === THREE.BackSide || la === THREE.DoubleSide) && n.normalModel.negate();
            ...
            Y = fa.vertexNormals;
            T = 0;
            for (aa = Y.length; T < aa; T++) (ia = n.vertexNormalsModel[T]), ia.copy(Y[T]), !1 === V && (la === THREE.BackSide || la === THREE.DoubleSide) && ia.negate(), ia.applyMatrix3(Va).normalize(), n.vertexNormalsModelView[T].copy(ia).applyMatrix3(O);
            ...
            n.color = fa.color;
            n.material = ka;
            qa.copy(n.centroidModel).applyProjection(K);
            n.z = qa.z;
            L.elements.push(n);
          }
        }
      } else if (ma instanceof THREE.Line) {
        Pa.multiplyMatrices(K, oa);
        ...
        for (fa = da.length; C < fa; C++)
          (T = a()),
            T.positionScreen.copy(da[C]).applyMatrix4(Pa),
            0 < (C + 1) % bb ||
              ((aa = j[i - 2]),
              ...
              !0 === c(wa, D) &&
                ...
                y === H ? ((xa = new THREE.RenderableLine()), G.push(xa), H++, y++, (v = xa)) : (v = G[y++]),
                v.v1.positionScreen.copy(wa),
                v.v2.positionScreen.copy(D),
                (v.z = Math.max(wa.z, D.z)),
                (v.material = ma.material),
                ma.material.vertexColors === THREE.VertexColors && (v.vertexColors[0].copy(ma.geometry.colors[C]), v.vertexColors[1].copy(ma.geometry.colors[C - 1])),
                L.elements.push(v)));
      }
    d = 0;
    for (h = L.sprites.length; d < h; d++)
      (ma = L.sprites[d].object),
        (oa = ma.matrixWorld),
        ma instanceof THREE.Particle &&
          ...
          0 < J.z &&
            1 > J.z &&
            (F === B ? ((V = new THREE.RenderableParticle()), A.push(V), B++, F++, (I = V)) : (I = A[F++]),
            (I.object = ma),
            (I.x = J.x / J.w),
            (I.y = J.y / J.w),
            (I.z = J.z),
            (I.rotation = ma.rotation.z),
            (I.scale.x = ma.scale.x * Math.abs(I.x - (J.x + f.projectionMatrix.elements[0]) / (J.w + f.projectionMatrix.elements[12]))),
            (I.scale.y = ma.scale.y * Math.abs(I.y - (J.y + f.projectionMatrix.elements[5]) / (J.w + f.projectionMatrix.elements[13]))),
            (I.material = ma.material),
            L.elements.push(I)));
    !0 === l && L.elements.sort(b);
    return L;
  };
};
...
THREE.Geometry.prototype = {
    ...
    for (b = this.faces.length; a < b; a++)
      (c = this.faces[a]),
        ...
        c instanceof THREE.Face3
          ? (c.centroid.add(this.vertices[c.a]), c.centroid.add(this.vertices[c.b]), c.centroid.add(this.vertices[c.c]), c.centroid.divideScalar(3))
          : c instanceof THREE.Face4 && (c.centroid.add(this.vertices[c.a]), c.centroid.add(this.vertices[c.b]), c.centroid.add(this.vertices[c.c]), c.centroid.add(this.vertices[c.d]), c.centroid.divideScalar(4));
  },
      ...
      for (c = this.faces.length; b < c; b++)
        (d = this.faces[b]),
          d instanceof THREE.Face3
            ? ((a = this.vertices[d.a]), (f = this.vertices[d.b]), (h = this.vertices[d.c]), i.subVectors(h, f), j.subVectors(a, f), i.cross(j), e[d.a].add(i), e[d.b].add(i), e[d.c].add(i))
            : d instanceof THREE.Face4 &&
              ((a = this.vertices[d.a]), (f = this.vertices[d.b]), (h = this.vertices[d.c]), (g = this.vertices[d.d]), l.subVectors(g, f), j.subVectors(a, f), l.cross(j), e[d.a].add(l), e[d.b].add(l), e[d.d].add(l), n.subVectors(g, h), m.subVectors(f, h), n.cross(m), e[d.b].add(n), e[d.c].add(n), e[d.d].add(n));
    } else {
      b = 0;
  ...
  computeMorphNormals: function () {
    ...
    for (b = this.morphTargets.length; a < b; a++) {
      if (!this.morphNormals[a]) {
        ...
        c = 0;
        for (d = this.faces.length; c < d; c++)
          (e = this.faces[c]), (i = new THREE.Vector3()), (j = e instanceof THREE.Face3 ? { a: new THREE.Vector3(), b: new THREE.Vector3(), c: new THREE.Vector3() } : { a: new THREE.Vector3(), b: new THREE.Vector3(), c: new THREE.Vector3(), d: new THREE.Vector3() }), h.push(i), g.push(j);
      }
      ...
      for (d = this.faces.length; c < d; c++)
        (e = this.faces[c]),
          ...
          (j = h.vertexNormals[c]),
          i.copy(e.normal),
          e instanceof THREE.Face3 ? (j.a.copy(e.vertexNormals[0]), j.b.copy(e.vertexNormals[1]), j.c.copy(e.vertexNormals[2])) : (j.a.copy(e.vertexNormals[0]), j.b.copy(e.vertexNormals[1]), j.c.copy(e.vertexNormals[2]), j.d.copy(e.vertexNormals[3]));
    }
    c = 0;
  ...
  computeTangents: function () {
    function a(a, b, c, d, e, f, z) {
      ...
      I = m.y - l.y;
      F = 1 / (y * I - G * H);
      C.set((I * q - H * t) * F, (I * r - H * p) * F, (I * s - H * v) * F);
      J.set((y * t - G * q) * F, (y * p - G * r) * F, (y * v - G * s) * F);
      B[b].add(C);
      B[c].add(C);
      B[d].add(C);
      L[b].add(J);
    ...
    var b,
      ...
      M = new THREE.Vector3();
    b = 0;
    for (c = this.vertices.length; b < c; b++) (B[b] = new THREE.Vector3()), (L[b] = new THREE.Vector3());
    b = 0;
    ...
    for (c = this.faces.length; b < c; b++) {
      f = this.faces[b];
      for (d = 0; d < f.vertexNormals.length; d++) M.copy(f.vertexNormals[d]), (e = f[w[d]]), (A = B[e]), N.copy(A), N.sub(M.multiplyScalar(M.dot(A))).normalize(), z.crossVectors(f.vertexNormals[d], A), (e = z.dot(L[e])), (e = 0 > e ? -1 : 1), (f.vertexTangents[d] = new THREE.Vector4(N.x, N.y, N.z, e));
    }
    this.hasTangents = !0;
  },
    ...
    for (h = this.faces.length; f < h; f++)
      if (((a = this.faces[f]), a instanceof THREE.Face3)) {
        ...
        if (0 <= d) {
          ...
          g = 0;
          for (i = this.faceVertexUvs.length; g < i; g++) (j = this.faceVertexUvs[g][f]) && j.splice(d, 1);
...
THREE.BufferGeometry.prototype = {
  ...
  computeTangents: function () {
    function a(a) {
      ...
      qa = i[a];
      K.copy(qa);
      K.sub(Pa.multiplyScalar(Pa.dot(qa))).normalize();
    ...
    if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv) console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");
      ...
      if (void 0 === this.attributes.tangent) {
        var h = 4 * f;
        this.attributes.tangent = { itemSize: 4, array: new Float32Array(h), numItems: h };
      }
      for (var g = this.attributes.tangent.array, i = [], j = [], h = 0; h < f; h++) (i[h] = new THREE.Vector3()), (j[h] = new THREE.Vector3());
      var l,
        n,
        m,
        q,
      ...
      for (J = w.length; C < J; ++C) {
        ...
        for (L += N; B < L; B += 3)
          (N = Z + b[B]),
            ...
            (G = A - G),
            (A = 1 / (H * G - y * I)),
            f.set((G * q - I * l) * A, (G * t - I * n) * A, (G * r - I * m) * A),
            h.set((H * l - y * q) * A, (H * n - y * t) * A, (H * m - y * r) * A),
            i[N].add(f),
            i[z].add(f),
            i[M].add(f),
            j[N].add(h),
      ...
      for (J = w.length; C < J; ++C) {
        ...
        Z = w[C].index;
        B = L;
        for (L += N; B < L; B += 3) (N = Z + b[B]), (z = Z + b[B + 1]), (M = Z + b[B + 2]), a(N), a(z), a(M);
      }
...
THREE.Loader.prototype = {
  ...
  createMaterial: function (a, b) {
    ...
    function e(a, e, f, g, i, j, p) {
      var s = /\.dds$/i.test(f),
        v = b + "/" + f;
      if (s) {
        var y = THREE.ImageUtils.loadCompressedTexture(v);
        a[e] = y;
      } else (y = document.createElement("canvas")), (a[e] = new THREE.Texture(y));
      a[e].sourceFile = f;
      ...
      j && ((f = { repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping }), void 0 !== f[j[0]] && (a[e].wrapS = f[j[0]]), void 0 !== f[j[1]] && (a[e].wrapT = f[j[1]]));
      p && (a[e].anisotropy = p);
      if (!s) {
        var G = a[e],
          a = new Image();
    ...
    a.mapNormal
      ? ((g = THREE.ShaderLib.normalmap),
        ...
        a.mapNormalFactor && j.uNormalScale.value.set(a.mapNormalFactor, a.mapNormalFactor),
        i.map && ((j.tDiffuse.value = i.map), (j.enableDiffuse.value = !0)),
        i.specularMap && ((j.tSpecular.value = i.specularMap), (j.enableSpecular.value = !0)),
        ...
        (g = new THREE.ShaderMaterial({ fragmentShader: g.fragmentShader, vertexShader: g.vertexShader, uniforms: j, lights: !0, fog: !0 })),
...
THREE.JSONLoader.prototype.loadAjaxJSON = function (a, b, c, d, e) {
  ...
  f.onreadystatechange = function () {
    ...
    else f.readyState === f.LOADING ? e && (0 === h && (h = f.getResponseHeader("Content-Length")), e({ total: h, loaded: f.responseText.length })) : f.readyState === f.HEADERS_RECEIVED && void 0 !== e && (h = f.getResponseHeader("Content-Length"));
  };
  f.open("GET", b, !0);
...
THREE.JSONLoader.prototype.parse = function (a, b) {
  ...
  var G = a.normals,
    H = a.colors,
    I = 0;
  for (e = 0; e < a.uvs.length; e++) a.uvs[e].length && I++;
  for (e = 0; e < I; e++) (c.faceUvs[e] = []), (c.faceVertexUvs[e] = []);
  g = 0;
  for (i = q.length; g < i; ) (j = new THREE.Vector3()), (j.x = q[g++] * d), (j.y = q[g++] * d), (j.z = q[g++] * d), c.vertices.push(j);
  g = 0;
  for (i = y.length; g < i; ) {
    q = y[g++];
    j = q & 1;
    ...
    t = q & 64;
    q &= 128;
    j ? ((r = new THREE.Face4()), (r.a = y[g++]), (r.b = y[g++]), (r.c = y[g++]), (r.d = y[g++]), (j = 4)) : ((r = new THREE.Face3()), (r.a = y[g++]), (r.b = y[g++]), (r.c = y[g++]), (j = 3));
    h && ((h = y[g++]), (r.materialIndex = h));
    h = c.faces.length;
    if (e) for (e = 0; e < I; e++) (p = a.uvs[e]), (m = y[g++]), (v = p[2 * m]), (m = p[2 * m + 1]), (c.faceUvs[e][h] = new THREE.Vector2(v, m));
    if (f)
      for (e = 0; e < I; e++) {
        p = a.uvs[e];
        s = [];
        for (f = 0; f < j; f++) (m = y[g++]), (v = p[2 * m]), (m = p[2 * m + 1]), (s[f] = new THREE.Vector2(v, m));
        c.faceVertexUvs[e][h] = s;
      }
    n && ((n = 3 * y[g++]), (f = new THREE.Vector3()), (f.x = G[n++]), (f.y = G[n++]), (f.z = G[n]), (r.normal = f));
    if (l) for (e = 0; e < j; e++) (n = 3 * y[g++]), (f = new THREE.Vector3()), (f.x = G[n++]), (f.y = G[n++]), (f.z = G[n]), r.vertexNormals.push(f);
    t && ((l = y[g++]), (l = new THREE.Color(H[l])), (r.color = l));
    if (q) for (e = 0; e < j; e++) (l = y[g++]), (l = new THREE.Color(H[l])), r.vertexColors.push(l);
    c.faces.push(r);
  }
  if (a.skinWeights) {
    g = 0;
    for (i = a.skinWeights.length; g < i; g += 2) (y = a.skinWeights[g]), (G = a.skinWeights[g + 1]), c.skinWeights.push(new THREE.Vector4(y, G, 0, 0));
  }
  if (a.skinIndices) {
    g = 0;
    for (i = a.skinIndices.length; g < i; g += 2) (y = a.skinIndices[g]), (G = a.skinIndices[g + 1]), c.skinIndices.push(new THREE.Vector4(y, G, 0, 0));
  }
  c.bones = a.bones;
  ...
  if (void 0 !== a.morphTargets) {
    ...
    for (i = a.morphTargets.length; g < i; g++) {
      ...
      H = c.morphTargets[g].vertices;
      I = a.morphTargets[g].vertices;
      y = 0;
      for (G = I.length; y < G; y += 3) (q = new THREE.Vector3()), (q.x = I[y] * d), (q.y = I[y + 1] * d), (q.z = I[y + 2] * d), H.push(q);
    }
  }
  if (void 0 !== a.morphColors) {
    ...
    for (i = a.morphColors.length; g < i; g++) {
      ...
      d = 0;
      for (y = H.length; d < y; d += 3) (I = new THREE.Color(16755200)), I.setRGB(H[d], H[d + 1], H[d + 2]), G.push(I);
    }
  }
  c.computeCentroids();
  ...
  parse: function (a) {
    ...
    switch (a.type) {
      ...
      case "MeshLambertMaterial":
        b = new THREE.MeshLambertMaterial({ color: a.color, ambient: a.ambient, emissive: a.emissive, opacity: a.opacity, transparent: a.transparent, wireframe: a.wireframe });
        break;
      ...
      case "MeshDepthMaterial":
        b = new THREE.MeshDepthMaterial({ opacity: a.opacity, transparent: a.transparent, wireframe: a.wireframe });
    }
    return b;
  },
};
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
  ...
  function f(a, b) {
    ...
    for (m in b) {
      var p = B.objects[m],
        s = b[m];
      if (void 0 === p) {
        if (s.type && s.type in n.hierarchyHandlerMap) {
          if (void 0 === s.loading) {
            ...
            h = {};
            for (var z in s) z in e || (h[z] = s[z]);
            t = B.materials[s.material];
            s.loading = !0;
            e = n.hierarchyHandlerMap[s.type].loaderObject;
            e.options ? e.load(d(s.url, C.urlBaseType), g(m, a, t, s)) : e.load(d(s.url, C.urlBaseType), g(m, a, t, s), h);
          }
        } else if (void 0 !== s.geometry) {
          if ((q = B.geometries[s.geometry])) {
            p = !1;
            t = B.materials[s.material];
            p = t instanceof THREE.ShaderMaterial;
            h = s.position;
            i = s.rotation;
            j = s.scale;
            c = s.matrix;
            l = s.quaternion;
            s.material || (t = new THREE.MeshFaceMaterial(B.face_materials[s.geometry]));
            t instanceof THREE.MeshFaceMaterial && 0 === t.materials.length && (t = new THREE.MeshFaceMaterial(B.face_materials[s.geometry]));
            if (t instanceof THREE.MeshFaceMaterial) for (e = 0; e < t.materials.length; e++) p = p || t.materials[e] instanceof THREE.ShaderMaterial;
            p && q.computeTangents();
            s.skin
              ? (p = new THREE.SkinnedMesh(q, t))
              : s.morph
              ? ((p = new THREE.MorphAnimMesh(q, t)), void 0 !== s.duration && (p.duration = s.duration), void 0 !== s.time && (p.time = s.time), void 0 !== s.mirroredLoop && (p.mirroredLoop = s.mirroredLoop), t.morphNormals && q.computeMorphNormals())
              : (p = new THREE.Mesh(q, t));
            p.name = m;
            c ? ((p.matrixAutoUpdate = !1), p.matrix.set(c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10], c[11], c[12], c[13], c[14], c[15])) : (p.position.fromArray(h), l ? (p.quaternion.fromArray(l), (p.useQuaternion = !0)) : p.rotation.fromArray(i), p.scale.fromArray(j));
            p.visible = s.visible;
            p.castShadow = s.castShadow;
            p.receiveShadow = s.receiveShadow;
            a.add(p);
            B.objects[m] = p;
          }
        } else
          "DirectionalLight" === s.type || "PointLight" === s.type || "AmbientLight" === s.type
            ? ((y = void 0 !== s.color ? s.color : 16777215),
              (G = void 0 !== s.intensity ? s.intensity : 1),
              "DirectionalLight" === s.type
                ? ((h = s.direction), (v = new THREE.DirectionalLight(y, G)), v.position.fromArray(h), s.target && (L.push({ object: v, targetName: s.target }), (v.target = null)))
                : "PointLight" === s.type
                ? ((h = s.position), (e = s.distance), (v = new THREE.PointLight(y, G, e)), v.position.fromArray(h))
                : "AmbientLight" === s.type && (v = new THREE.AmbientLight(y)),
              a.add(v),
              (v.name = m),
              (B.lights[m] = v),
              (B.objects[m] = v))
            ...
            ? ((h = s.position),
              (i = s.rotation),
              (l = s.quaternion),
              "PerspectiveCamera" === s.type ? (r = new THREE.PerspectiveCamera(s.fov, s.aspect, s.near, s.far)) : "OrthographicCamera" === s.type && (r = new THREE.OrthographicCamera(s.left, s.right, s.top, s.bottom, s.near, s.far)),
              (r.name = m),
              r.position.fromArray(h),
              void 0 !== l ? (r.quaternion.fromArray(l), (r.useQuaternion = !0)) : void 0 !== i && r.rotation.fromArray(i),
              a.add(r),
              (B.cameras[m] = r),
              (B.objects[m] = r))
            : ((h = s.position),
              ...
              l ? (p.quaternion.fromArray(l), (p.useQuaternion = !0)) : p.rotation.fromArray(i),
              p.scale.fromArray(j),
              (p.visible = void 0 !== s.visible ? s.visible : !1),
              a.add(p),
              (B.objects[m] = p),
              (B.empties[m] = p));
        if (p) {
          if (void 0 !== s.userData) for (var A in s.userData) p.userData[A] = s.userData[A];
          if (void 0 !== s.groups) for (e = 0; e < s.groups.length; e++) (h = s.groups[e]), void 0 === B.groups[h] && (B.groups[h] = []), B.groups[h].push(m);
        }
      }
      void 0 !== p && void 0 !== s.children && f(p, s.children);
    }
  }
  function h(a) {
    return function (b, c) {
  ...
  function g(a, b, c, d) {
    return function (f) {
      ...
      g ? (f.quaternion.fromArray(g), (f.useQuaternion = !0)) : f.rotation.fromArray(h);
      f.scale.fromArray(i);
      c &&
  ...
  function j() {
    n.callbackProgress({ totalModels: F, totalTextures: A, loadedModels: F - H, loadedTextures: A - I }, B);
    n.onLoadProgress();
    if (0 === H && 0 === I) {
  ...
  var n = this,
    ...
    C = a,
    J;
  for (J in this.geometryHandlerMap) (a = this.geometryHandlerMap[J].loaderClass), (this.geometryHandlerMap[J].loaderObject = new a());
  for (J in this.hierarchyHandlerMap) (a = this.hierarchyHandlerMap[J].loaderClass), (this.hierarchyHandlerMap[J].loaderObject = new a());
  I = H = 0;
  B = { scene: new THREE.Scene(), geometries: {}, face_materials: {}, materials: {}, textures: {}, objects: {}, cameras: {}, lights: {}, fogs: {}, empties: {}, groups: {} };
  if (C.transform && ((J = C.transform.position), (a = C.transform.rotation), (c = C.transform.scale), J && B.scene.position.fromArray(J), a && B.scene.rotation.fromArray(a), c && B.scene.scale.fromArray(c), J || a || c)) B.scene.updateMatrix(), B.scene.updateMatrixWorld();
  J = function (a) {
    return function () {
      I -= a;
      j();
  ...
  for (var N in C.fogs) (a = C.fogs[N]), "linear" === a.type ? (p = new THREE.Fog(0, a.near, a.far)) : "exp2" === a.type && (p = new THREE.FogExp2(0, a.density)), (a = a.color), p.color.setRGB(a[0], a[1], a[2]), (B.fogs[N] = p);
  for (var z in C.geometries) (p = C.geometries[z]), p.type in this.geometryHandlerMap && ((H += 1), n.onLoadStart());
  for (var M in C.objects)
    l(C.objects[M], function (a) {
      a.type && a.type in n.hierarchyHandlerMap && ((H += 1), n.onLoadStart());
    });
  F = H;
  for (z in C.geometries)
    if (((p = C.geometries[z]), "cube" === p.type)) (q = new THREE.CubeGeometry(p.width, p.height, p.depth, p.widthSegments, p.heightSegments, p.depthSegments)), (q.name = z), (B.geometries[z] = q);
    else if ("plane" === p.type) (q = new THREE.PlaneGeometry(p.width, p.height, p.widthSegments, p.heightSegments)), (q.name = z), (B.geometries[z] = q);
    else if ("sphere" === p.type) (q = new THREE.SphereGeometry(p.radius, p.widthSegments, p.heightSegments)), (q.name = z), (B.geometries[z] = q);
    else if ("cylinder" === p.type) (q = new THREE.CylinderGeometry(p.topRad, p.botRad, p.height, p.radSegs, p.heightSegs)), (q.name = z), (B.geometries[z] = q);
    else if ("torus" === p.type) (q = new THREE.TorusGeometry(p.radius, p.tube, p.segmentsR, p.segmentsT)), (q.name = z), (B.geometries[z] = q);
    else if ("icosahedron" === p.type) (q = new THREE.IcosahedronGeometry(p.radius, p.subdivisions)), (q.name = z), (B.geometries[z] = q);
    else if (p.type in this.geometryHandlerMap) {
      M = {};
      for (s in p) "type" !== s && "url" !== s && (M[s] = p[s]);
      this.geometryHandlerMap[p.type].loaderObject.load(d(p.url, C.urlBaseType), h(z), M);
    } else "embedded" === p.type && ((M = C.embeds[p.id]), (M.metadata = C.metadata), M && ((M = this.geometryHandlerMap.ascii.loaderObject.parse(M, "")), i(z)(M.geometry, M.materials)));
  for (var w in C.textures)
    if (((z = C.textures[w]), z.url instanceof Array)) {
      I += z.url.length;
      for (s = 0; s < z.url.length; s++) n.onLoadStart();
    } else (I += 1), n.onLoadStart();
  A = I;
  for (w in C.textures) {
    z = C.textures[w];
    ...
    if (z.url instanceof Array) {
      M = z.url.length;
      p = [];
      for (s = 0; s < M; s++) p[s] = d(z.url[s], C.urlBaseType);
      s = (s = /\.dds$/i.test(p[0])) ? THREE.ImageUtils.loadCompressedTextureCube(p, z.mapping, J(M)) : THREE.ImageUtils.loadTextureCube(p, z.mapping, J(M));
    } else
      (s = /\.dds$/i.test(z.url)),
        (M = d(z.url, C.urlBaseType)),
        (p = J(1)),
        (s = s ? THREE.ImageUtils.loadCompressedTexture(M, z.mapping, p) : THREE.ImageUtils.loadTexture(M, z.mapping, p)),
        void 0 !== THREE[z.minFilter] && (s.minFilter = THREE[z.minFilter]),
        void 0 !== THREE[z.magFilter] && (s.magFilter = THREE[z.magFilter]),
        z.anisotropy && (s.anisotropy = z.anisotropy),
        z.repeat && (s.repeat.set(z.repeat[0], z.repeat[1]), 1 !== z.repeat[0] && (s.wrapS = THREE.RepeatWrapping), 1 !== z.repeat[1] && (s.wrapT = THREE.RepeatWrapping)),
        z.offset && s.offset.set(z.offset[0], z.offset[1]),
        z.wrap && ((M = { repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping }), void 0 !== M[z.wrap[0]] && (s.wrapS = M[z.wrap[0]]), void 0 !== M[z.wrap[1]] && (s.wrapT = M[z.wrap[1]]));
    B.textures[w] = s;
  }
  var Z, K;
  for (Z in C.materials) {
    w = C.materials[Z];
    for (K in w.parameters)
      "envMap" === K || "map" === K || "lightMap" === K || "bumpMap" === K
        ? (w.parameters[K] = B.textures[w.parameters[K]])
        : "shading" === K
        ? (w.parameters[K] = "flat" === w.parameters[K] ? THREE.FlatShading : THREE.SmoothShading)
        : "side" === K
        ? (w.parameters[K] = "double" == w.parameters[K] ? THREE.DoubleSide : "back" == w.parameters[K] ? THREE.BackSide : THREE.FrontSide)
        : "blending" === K
        ? (w.parameters[K] = w.parameters[K] in THREE ? THREE[w.parameters[K]] : THREE.NormalBlending)
        : "combine" === K
        ? (w.parameters[K] = w.parameters[K] in THREE ? THREE[w.parameters[K]] : THREE.MultiplyOperation)
        : "vertexColors" === K
        ? "face" == w.parameters[K]
          ? (w.parameters[K] = THREE.FaceColors)
          : w.parameters[K] && (w.parameters[K] = THREE.VertexColors)
        : "wrapRGB" === K && ((J = w.parameters[K]), (w.parameters[K] = new THREE.Vector3(J[0], J[1], J[2])));
    ...
    w.parameters.normalMap
      ? ((J = THREE.ShaderLib.normalmap),
        (z = THREE.UniformsUtils.clone(J.uniforms)),
        (s = w.parameters.color),
        (M = w.parameters.specular),
        (p = w.parameters.ambient),
        (N = w.parameters.shininess),
        (z.tNormal.value = B.textures[w.parameters.normalMap]),
        w.parameters.normalScale && z.uNormalScale.value.set(w.parameters.normalScale[0], w.parameters.normalScale[1]),
        w.parameters.map && ((z.tDiffuse.value = w.parameters.map), (z.enableDiffuse.value = !0)),
        w.parameters.envMap && ((z.tCube.value = w.parameters.envMap), (z.enableReflection.value = !0), (z.uReflectivity.value = w.parameters.reflectivity)),
        w.parameters.lightMap && ((z.tAO.value = w.parameters.lightMap), (z.enableAO.value = !0)),
        w.parameters.specularMap && ((z.tSpecular.value = B.textures[w.parameters.specularMap]), (z.enableSpecular.value = !0)),
        w.parameters.displacementMap && ((z.tDisplacement.value = B.textures[w.parameters.displacementMap]), (z.enableDisplacement.value = !0), (z.uDisplacementBias.value = w.parameters.displacementBias), (z.uDisplacementScale.value = w.parameters.displacementScale)),
        z.uDiffuseColor.value.setHex(s),
        z.uSpecularColor.value.setHex(M),
        z.uAmbientColor.value.setHex(p),
        (z.uShininess.value = N),
        w.parameters.opacity && (z.uOpacity.value = w.parameters.opacity),
        (t = new THREE.ShaderMaterial({ fragmentShader: J.fragmentShader, vertexShader: J.vertexShader, uniforms: z, lights: !0, fog: !0 })))
      : (t = new THREE[w.type](w.parameters));
    t.name = Z;
    B.materials[Z] = t;
  }
  for (Z in C.materials)
    if (((w = C.materials[Z]), w.parameters.materials)) {
      K = [];
      for (s = 0; s < w.parameters.materials.length; s++) K.push(B.materials[w.parameters.materials[s]]);
      B.materials[Z].materials = K;
    }
  e();
  B.cameras && C.defaults.camera && (B.currentCamera = B.cameras[C.defaults.camera]);
  B.fogs && C.defaults.fog && (B.scene.fog = B.fogs[C.defaults.fog]);
  n.callbackSync(B);
  j();
};
...
THREE.CanvasRenderer = function (a) {
  function b(a, b, c) {
    for (var d = 0, e = F.length; d < e; d++) {
      ...
      } else f instanceof THREE.PointLight && ((h = Xa.getPositionFromMatrix(f.matrixWorld)), (g = b.dot(Xa.subVectors(h, a).normalize())), 0 >= g || ((g *= 0 == f.distance ? 1 : 1 - Math.min(a.distanceTo(h) / f.distance, 1)), 0 != g && ((g *= f.intensity), c.add(Xb.multiplyScalar(g)))));
    }
  }
  function c(a, c, e, l, q, r, U, p) {
    ...
    (p instanceof THREE.MeshLambertMaterial || p instanceof THREE.MeshPhongMaterial) && null === p.map
      ? (Qa.copy(p.color),
        ...
        !1 === p.wireframe && p.shading == THREE.SmoothShading && 3 == U.vertexNormalsLength
          ? (ra.copy(ib),
            ka.copy(ib),
            ua.copy(ib),
          ...
          : (ha.copy(ib), b(U.centroidModel, U.normalModel, ha), ha.multiply(Qa).add(Ya), !0 === p.wireframe ? f(ha, p.wireframeLinewidth, p.wireframeLinecap, p.wireframeLinejoin) : h(ha)))
      : p instanceof THREE.MeshBasicMaterial || p instanceof THREE.MeshLambertMaterial || p instanceof THREE.MeshPhongMaterial
      ? null !== p.map
        ? p.map.mapping instanceof THREE.UVMapping && ((Ga = U.uvs[0]), g(ya, Ha, fa, da, T, aa, Ga[l].x, Ga[l].y, Ga[q].x, Ga[q].y, Ga[r].x, Ga[r].y, p.map))
        : null !== p.envMap
        ...
        : (ha.copy(p.color), p.vertexColors === THREE.FaceColors && ha.multiply(U.color), !0 === p.wireframe ? f(ha, p.wireframeLinewidth, p.wireframeLinecap, p.wireframeLinejoin) : h(ha))
      : p instanceof THREE.MeshDepthMaterial
      ? ((Sa = D.near),
        (xb = D.far),
        (ra.r = ra.g = ra.b = 1 - y(a.positionScreen.z * a.positionScreen.w, Sa, xb)),
        (ka.r = ka.g = ka.b = 1 - y(c.positionScreen.z * c.positionScreen.w, Sa, xb)),
        (ua.r = ua.g = ua.b = 1 - y(e.positionScreen.z * e.positionScreen.w, Sa, xb)),
        Ra.addColors(ka, ua).multiplyScalar(0.5),
        (lb = j(ra, ka, ua, Ra)),
        i(ya, Ha, fa, da, T, aa, 0, 0, 1, 0, 0, 1, lb))
      : p instanceof THREE.MeshNormalMaterial &&
        (p.shading == THREE.FlatShading
          ? ((a = U.normalModelView), ha.setRGB(a.x, a.y, a.z).multiplyScalar(0.5).addScalar(0.5), !0 === p.wireframe ? f(ha, p.wireframeLinewidth, p.wireframeLinecap, p.wireframeLinejoin) : h(ha))
  ...
  function g(a, b, c, d, e, f, g, k, i, j, n, l, m) {
    if (!(m instanceof THREE.DataTexture || void 0 === m.image || 0 == m.image.width)) {
      if (!0 === m.needsUpdate) {
        ...
        Jb[m.id] = z.createPattern(m.image, !0 === p && !0 === q ? "repeat" : !0 === p && !1 === q ? "repeat-x" : !1 === p && !0 === q ? "repeat-y" : "no-repeat");
        m.needsUpdate = !1;
      }
      ...
      var p = m.offset.x / m.repeat.x,
        ...
        p = i * l - n * j;
      0 === p
        ? (void 0 === Ab[m.id] && ((b = document.createElement("canvas")), (b.width = m.image.width), (b.height = m.image.height), (b = b.getContext("2d")), b.drawImage(m.image, 0, 0), (Ab[m.id] = b.getImageData(0, 0, m.image.width, m.image.height).data)),
          (b = Ab[m.id]),
          (g = 4 * (Math.floor(g) + Math.floor(k) * m.image.width)),
          ha.setRGB(b[g] / 255, b[g + 1] / 255, b[g + 2] / 255),
          h(ha))
        : ((p = 1 / p), (m = (l * c - j * e) * p), (j = (l * d - j * f) * p), (c = (i * e - n * c) * p), (d = (i * f - n * d) * p), (a = a - m * g - c * k), (g = b - j * g - d * k), z.save(), z.transform(m, j, c, d, a, g), z.fill(), z.restore());
    }
  }
  function i(a, b, c, d, e, f, h, g, k, i, j, n, m) {
    var l, p;
    l = m.width - 1;
    p = m.height - 1;
    h *= l;
  ...
  function n(a) {
    Z !== a && (Z = z.globalAlpha = a);
  }
  function m(a) {
    K !== a && (a === THREE.NormalBlending ? (z.globalCompositeOperation = "source-over") : a === THREE.AdditiveBlending ? (z.globalCompositeOperation = "lighter") : a === THREE.SubtractiveBlending && (z.globalCompositeOperation = "darker"), (K = a));
  }
  function q(a) {
    Va !== a && (Va = z.lineWidth = a);
  }
  function t(a) {
    O !== a && (O = z.lineCap = a);
  }
  function r(a) {
    qa !== a && (qa = z.lineJoin = a);
  }
  function p(a) {
    oa !== a && (oa = z.strokeStyle = a);
  }
  function s(a) {
    Pa !== a && (Pa = z.fillStyle = a);
  }
  function v(a, b) {
    if (Fa !== a || wa !== b) z.setLineDash([a, b]), (Fa = a), (wa = b);
  }
  ...
  this.clear = function () {
    z.setTransform(1, 0, 0, -1, J, N);
    !1 === na.empty() &&
      (na.intersect(fb),
      na.expandByScalar(2),
      1 > w && z.clearRect(na.min.x | 0, na.min.y | 0, (na.max.x - na.min.x) | 0, (na.max.y - na.min.y) | 0),
      0 < w && (m(THREE.NormalBlending), n(1), s("rgba(" + Math.floor(255 * M.r) + "," + Math.floor(255 * M.g) + "," + Math.floor(255 * M.b) + "," + w + ")"), z.fillRect(na.min.x | 0, na.min.y | 0, (na.max.x - na.min.x) | 0, (na.max.y - na.min.y) | 0)),
      na.makeEmpty());
  };
  this.render = function (a, g) {
    if (!1 === g instanceof THREE.Camera) console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
      ...
      H = A.projectScene(a, g, this.sortObjects, this.sortElements);
      I = H.elements;
      F = H.lights;
      D = g;
      ib.setRGB(0, 0, 0);
      Tb.setRGB(0, 0, 0);
      Ub.setRGB(0, 0, 0);
      for (var k = 0, B = F.length; k < B; k++) {
        var w = F[k],
          C = w.color;
        w instanceof THREE.AmbientLight ? ib.add(C) : w instanceof THREE.DirectionalLight ? Tb.add(C) : w instanceof THREE.PointLight && Ub.add(C);
      }
      k = 0;
      for (B = I.length; k < B; k++) {
        var U = I[k],
          w = U.material;
        if (!(void 0 === w || !1 === w.visible)) {
          ...
          if (U instanceof THREE.RenderableParticle) {
            ...
            w instanceof THREE.ParticleBasicMaterial
              ? null === w.map
                ? ((vb = U.object.scale.x),
                  ...
                  (vb *= U.scale.x * J),
                  (zb *= U.scale.y * N),
                  va.min.set(C.x - vb, C.y - zb),
                  va.max.set(C.x + vb, C.y + zb),
                  !1 === fb.isIntersectionBox(va) ? va.makeEmpty() : (s(w.color.getStyle()), z.save(), z.translate(C.x, C.y), z.rotate(-U.rotation), z.scale(vb, zb), z.fillRect(-1, -1, 2, 2), z.restore()))
                : ((Zb = w.map.image),
                  (Jc = Zb.width >> 1),
                  (Kc = Zb.height >> 1),
                  (vb = U.scale.x * J),
                  ...
                  (mb = vb * Jc),
                  (nb = zb * Kc),
                  va.min.set(C.x - mb, C.y - nb),
                  va.max.set(C.x + mb, C.y + nb),
                  !1 === fb.isIntersectionBox(va) ? va.makeEmpty() : (z.save(), z.translate(C.x, C.y), z.rotate(-U.rotation), z.scale(vb, -zb), z.translate(-Jc, -Kc), z.drawImage(Zb, 0, 0), z.restore()))
              : w instanceof THREE.ParticleCanvasMaterial &&
                ((mb = U.scale.x * J),
                (nb = U.scale.y * N),
                va.min.set(C.x - mb, C.y - nb),
                va.max.set(C.x + mb, C.y + nb),
                !1 === fb.isIntersectionBox(va) ? va.makeEmpty() : (p(w.color.getStyle()), s(w.color.getStyle()), z.save(), z.translate(C.x, C.y), z.rotate(-U.rotation), z.scale(mb, nb), w.program(z), z.restore()));
            ...
            if (((V = U.v1), (ea = U.v2), (V.positionScreen.x *= J), (V.positionScreen.y *= N), (ea.positionScreen.x *= J), (ea.positionScreen.y *= N), va.setFromPoints([V.positionScreen, ea.positionScreen]), !0 === fb.isIntersectionBox(va)))
              if (((C = V), (mb = ea), n(w.opacity), m(w.blending), z.beginPath(), z.moveTo(C.positionScreen.x, C.positionScreen.y), z.lineTo(mb.positionScreen.x, mb.positionScreen.y), w instanceof THREE.LineBasicMaterial)) {
                q(w.linewidth);
                t(w.linecap);
                r(w.linejoin);
                if (w.vertexColors !== THREE.VertexColors) p(w.color.getStyle());
                else if (((nb = U.vertexColors[0].getStyle()), (U = U.vertexColors[1].getStyle()), nb === U)) p(nb);
                else {
                  try {
                    var wc = z.createLinearGradient(C.positionScreen.x, C.positionScreen.y, mb.positionScreen.x, mb.positionScreen.y);
              ...
              } else w instanceof THREE.LineDashedMaterial && (q(w.linewidth), t(w.linecap), r(w.linejoin), p(w.color.getStyle()), v(w.dashSize, w.gapSize), z.stroke(), va.expandByScalar(2 * w.linewidth), v(null, null));
            ...
            0 < w.overdraw && (l(V.positionScreen, ea.positionScreen, w.overdraw), l(ea.positionScreen, pa.positionScreen, w.overdraw), l(pa.positionScreen, V.positionScreen, w.overdraw));
            va.setFromPoints([V.positionScreen, ea.positionScreen, pa.positionScreen]);
            ...
            0 < w.overdraw && (l(V.positionScreen, ea.positionScreen, w.overdraw), l(ea.positionScreen, Ua.positionScreen, w.overdraw), l(Ua.positionScreen, V.positionScreen, w.overdraw), l(pa.positionScreen, pb.positionScreen, w.overdraw), l(pa.positionScreen, ub.positionScreen, w.overdraw));
            va.setFromPoints([V.positionScreen, ea.positionScreen, pa.positionScreen, Ua.positionScreen]);
            !0 === fb.isIntersectionBox(va) &&
              ...
              n(w.opacity),
              m(w.blending),
              (void 0 !== w.map && null !== w.map) || (void 0 !== w.envMap && null !== w.envMap)
                ? (c(C, mb, vb, 0, 1, 3, U, w), c(zb, nb, Zb, 1, 2, 3, U, w))
                : ((ya = C.positionScreen.x),
                  (Ha = C.positionScreen.y),
                  ...
                  w instanceof THREE.MeshLambertMaterial || w instanceof THREE.MeshPhongMaterial
                    ? (Qa.copy(w.color),
                      Ya.copy(w.emissive),
                      w.vertexColors === THREE.FaceColors && Qa.multiply(U.color),
                      !1 === w.wireframe && w.shading == THREE.SmoothShading && 4 == U.vertexNormalsLength
                        ? (ra.copy(ib),
                          ka.copy(ib),
                          ua.copy(ib),
                          Ra.copy(ib),
                        ...
                        : (ha.copy(ib), b(U.centroidModel, U.normalModel, ha), ha.multiply(Qa).add(Ya), e(ya, Ha, fa, da, T, aa, la, Y), !0 === w.wireframe ? f(ha, w.wireframeLinewidth, w.wireframeLinecap, w.wireframeLinejoin) : h(ha)))
                    : w instanceof THREE.MeshBasicMaterial
                    ? (ha.copy(w.color), w.vertexColors === THREE.FaceColors && ha.multiply(U.color), e(ya, Ha, fa, da, T, aa, la, Y), !0 === w.wireframe ? f(ha, w.wireframeLinewidth, w.wireframeLinecap, w.wireframeLinejoin) : h(ha))
                    : w instanceof THREE.MeshNormalMaterial
                    ? ((C = void 0),
                      w.shading == THREE.FlatShading
                        ? ((C = U.normalModelView), ha.setRGB(C.x, C.y, C.z).multiplyScalar(0.5).addScalar(0.5), e(ya, Ha, fa, da, T, aa, la, Y), !0 === w.wireframe ? f(ha, w.wireframeLinewidth, w.wireframeLinecap, w.wireframeLinejoin) : h(ha))
                        : w.shading == THREE.SmoothShading &&
                          ((C = U.vertexNormalsModelView[0]),
                          ra.setRGB(C.x, C.y, C.z).multiplyScalar(0.5).addScalar(0.5),
                          (C = U.vertexNormalsModelView[1]),
                          ka.setRGB(C.x, C.y, C.z).multiplyScalar(0.5).addScalar(0.5),
                          (C = U.vertexNormalsModelView[3]),
                          ua.setRGB(C.x, C.y, C.z).multiplyScalar(0.5).addScalar(0.5),
                          (C = U.vertexNormalsModelView[2]),
                          Ra.setRGB(C.x, C.y, C.z).multiplyScalar(0.5).addScalar(0.5),
                          (lb = j(ra, ka, ua, Ra)),
                          d(ya, Ha, fa, da, la, Y),
                          i(ya, Ha, fa, da, la, Y, 0, 0, 1, 0, 0, 1, lb),
                    ...
                    : w instanceof THREE.MeshDepthMaterial &&
                      ((Sa = D.near),
                      (xb = D.far),
                      (ra.r = ra.g = ra.b = 1 - y(C.positionScreen.z * C.positionScreen.w, Sa, xb)),
                      (ka.r = ka.g = ka.b = 1 - y(mb.positionScreen.z * mb.positionScreen.w, Sa, xb)),
                      (ua.r = ua.g = ua.b = 1 - y(vb.positionScreen.z * vb.positionScreen.w, Sa, xb)),
                      (Ra.r = Ra.g = Ra.b = 1 - y(nb.positionScreen.z * nb.positionScreen.w, Sa, xb)),
                      (lb = j(ra, ka, ua, Ra)),
                      d(ya, Ha, fa, da, la, Y),
                      i(ya, Ha, fa, da, la, Y, 0, 0, 1, 0, 0, 1, lb),
                      d(ma, xa, T, aa, bb, ia),
...
THREE.ShaderLib = {
  ...
  phong: {
    uniforms: THREE.UniformsUtils.merge([
      ...
      { ambient: { type: "c", value: new THREE.Color(16777215) }, emissive: { type: "c", value: new THREE.Color(0) }, specular: { type: "c", value: new THREE.Color(1118481) }, shininess: { type: "f", value: 30 }, wrapRGB: { type: "v3", value: new THREE.Vector3(1, 1, 1) } },
    ]),
    vertexShader: [
      "#define PHONG\nvarying vec3 vViewPosition;\nvarying vec3 vNormal;",
      THREE.ShaderChunk.map_pars_vertex,
...
THREE.WebGLRenderer = function (a) {
    ...
    if (d.attributes) {
      ...
      for (var p in d.attributes) {
        ...
        if (!c.__webglInitialized || c.createUniqueBuffers)
          (c.__webglInitialized = !0), (g = 1), "v2" === c.type ? (g = 2) : "v3" === c.type ? (g = 3) : "v4" === c.type ? (g = 4) : "c" === c.type && (g = 3), (c.size = g), (c.array = new Float32Array(i * g)), (c.buffer = k.createBuffer()), (c.buffer.belongsToAttribute = p), (j.needsUpdate = !0), (c.__original = j);
  ...
  function n(a, b, c) {
    if (a.length) for (var d = 0, e = a.length; d < e; d++) (ya = pa = null), (pb = ub = T = da = bb = xa = aa = -1), (yb = !0), a[d].render(b, c, Xb, Jb), (ya = pa = null), (pb = ub = T = da = bb = xa = aa = -1), (yb = !0);
  }
    ...
    for (var m = i; m !== b; m += n)
      if (((k = a[m]), k.render)) {
        ...
        if (g) k = g;
          ...
          L(k.polygonOffset, k.polygonOffsetFactor, k.polygonOffsetUnits);
        }
        D.setMaterialFaces(k);
        j instanceof THREE.BufferGeometry ? D.renderBufferDirect(d, e, f, k, j, i) : D.renderBuffer(d, e, f, k, j, i);
      }
  }
    ...
    for (var g, k, i = 0, j = a.length; i < j; i++)
      if (((g = a[i]), (k = g.object), k.visible)) {
        if (h) g = h;
          ...
          L(g.polygonOffset, g.polygonOffsetFactor, g.polygonOffsetUnits);
        }
  ...
  function t(a, b) {
    var e, f, h, g;
    if (void 0 === a.__webglInit && ((a.__webglInit = !0), (a._modelViewMatrix = new THREE.Matrix4()), (a._normalMatrix = new THREE.Matrix3()), void 0 !== a.geometry && void 0 === a.geometry.__webglInit && ((a.geometry.__webglInit = !0), a.geometry.addEventListener("dispose", kc)), (f = a.geometry), void 0 !== f))
      if (f instanceof THREE.BufferGeometry) {
        var i, j;
        for (i in f.attributes) (j = "index" === i ? k.ELEMENT_ARRAY_BUFFER : k.ARRAY_BUFFER), (g = f.attributes[i]), (g.buffer = k.createBuffer()), k.bindBuffer(j, g.buffer), k.bufferData(j, g.array, k.STATIC_DRAW);
        ...
        if (void 0 === f.geometryGroups) {
          ...
          for (n = i.faces.length; h < n; h++)
            (m = i.faces[h]),
              (l = v ? m.materialIndex : 0),
              void 0 === j[l] && (j[l] = { hash: l, counter: 0 }),
              (q = j[l].hash + "_" + j[l].counter),
              void 0 === i.geometryGroups[q] && (i.geometryGroups[q] = { faces3: [], faces4: [], materialIndex: l, vertices: 0, numMorphTargets: s, numMorphNormals: t }),
              (p = m instanceof THREE.Face3 ? 3 : 4),
              65535 < i.geometryGroups[q].vertices + p && ((j[l].counter += 1), (q = j[l].hash + "_" + j[l].counter), void 0 === i.geometryGroups[q] && (i.geometryGroups[q] = { faces3: [], faces4: [], materialIndex: l, vertices: 0, numMorphTargets: s, numMorphNormals: t })),
              m instanceof THREE.Face3 ? i.geometryGroups[q].faces3.push(h) : i.geometryGroups[q].faces4.push(h),
              (i.geometryGroups[q].vertices += p);
    ...
    if (void 0 === a.__webglActive) {
      if (a instanceof THREE.Mesh)
        if (((f = a.geometry), f instanceof THREE.BufferGeometry)) r(b.__webglObjects, f, a);
        else {
          if (f instanceof THREE.Geometry) for (e in f.geometryGroups) (g = f.geometryGroups[e]), r(b.__webglObjects, g, a);
        }
      else
        a instanceof THREE.Ribbon || a instanceof THREE.Line || a instanceof THREE.ParticleSystem
          ? ((f = a.geometry), r(b.__webglObjects, f, a))
          : a instanceof THREE.ImmediateRenderObject || a.immediateRenderCallback
          ? b.__webglObjectsImmediate.push({ id: null, object: a, opaque: null, transparent: null, z: 0 })
  ...
  function v(a, b) {
    a instanceof THREE.Mesh || a instanceof THREE.ParticleSystem || a instanceof THREE.Ribbon || a instanceof THREE.Line
      ? y(b.__webglObjects, a)
      : a instanceof THREE.Sprite
      ? G(b.__webglSprites, a)
      : a instanceof THREE.LensFlare
      ? G(b.__webglFlares, a)
      : (a instanceof THREE.ImmediateRenderObject || a.immediateRenderCallback) && y(b.__webglObjectsImmediate, a);
  ...
  function H(a, b, c, d, e) {
    ...
    if (f) {
            ...
            (n = b[c]),
              n.onlyShadow ||
                ...
                n instanceof THREE.AmbientLight
                  ? n.visible && (D.gammaInput ? ((j += p.r * p.r), (l += p.g * p.g), (m += p.b * p.b)) : ((j += p.r), (l += p.g), (m += p.b)))
                  : n instanceof THREE.DirectionalLight
                  ? ((da += 1),
                    n.visible &&
                      (Ca.getPositionFromMatrix(n.matrixWorld), Ga.getPositionFromMatrix(n.target.matrixWorld), Ca.sub(Ga), Ca.normalize(), (0 === Ca.x && 0 === Ca.y && 0 === Ca.z) || ((n = 3 * O), (v[n] = Ca.x), (v[n + 1] = Ca.y), (v[n + 2] = Ca.z), D.gammaInput ? F(t, n, p, q * q) : A(t, n, p, q), (O += 1))))
                  : n instanceof THREE.PointLight
                  ? ((R += 1), n.visible && ((ba = 3 * ea), D.gammaInput ? F(y, ba, p, q * q) : A(y, ba, p, q), Ga.getPositionFromMatrix(n.matrixWorld), (z[ba] = Ga.x), (z[ba + 1] = Ga.y), (z[ba + 2] = Ga.z), (B[ea] = r), (ea += 1)))
                  : n instanceof THREE.SpotLight
                  ? ((S += 1),
                    n.visible &&
                      ((ba = 3 * T),
                      D.gammaInput ? F(C, ba, p, q * q) : A(C, ba, p, q),
                  ...
                  : n instanceof THREE.HemisphereLight &&
                    ...
                    n.visible &&
                      ...
                      Ca.normalize(),
                      (0 === Ca.x && 0 === Ca.y && 0 === Ca.z) || ((r = 3 * aa), (M[r] = Ca.x), (M[r + 1] = Ca.y), (M[r + 2] = Ca.z), (p = n.color), (n = n.groundColor), D.gammaInput ? ((q *= q), F(K, r, p, q), F(V, r, n, q)) : (A(K, r, p, q), A(V, r, n, q)), (aa += 1)))));
          c = 3 * O;
          for (f = Math.max(t.length, 3 * da); c < f; c++) t[c] = 0;
          c = 3 * ea;
          for (f = Math.max(y.length, 3 * R); c < f; c++) y[c] = 0;
          c = 3 * T;
      ...
      d instanceof THREE.LineBasicMaterial
        ...
        ? ((i.diffuse.value = d.color), (i.opacity.value = d.opacity), (i.dashSize.value = d.dashSize), (i.totalSize.value = d.dashSize + d.gapSize), (i.scale.value = d.scale))
        : d instanceof THREE.ParticleBasicMaterial
        ? ((i.psColor.value = d.color), (i.opacity.value = d.opacity), (i.size.value = d.size), (i.scale.value = Z.height / 2), (i.map.value = d.map))
        : d instanceof THREE.MeshPhongMaterial
        ? ((i.shininess.value = d.shininess),
          D.gammaInput ? (i.ambient.value.copyGammaToLinear(d.ambient), i.emissive.value.copyGammaToLinear(d.emissive), i.specular.value.copyGammaToLinear(d.specular)) : ((i.ambient.value = d.ambient), (i.emissive.value = d.emissive), (i.specular.value = d.specular)),
          d.wrapAround && i.wrapRGB.value.copy(d.wrapRGB))
        : d instanceof THREE.MeshLambertMaterial
        ? (D.gammaInput ? (i.ambient.value.copyGammaToLinear(d.ambient), i.emissive.value.copyGammaToLinear(d.emissive)) : ((i.ambient.value = d.ambient), (i.emissive.value = d.emissive)), d.wrapAround && i.wrapRGB.value.copy(d.wrapRGB))
      ...
      if (e.receiveShadow && !d._shadowPass && i.shadowMatrix) {
        ...
        for (f = b.length; c < f; c++)
          if (((j = b[c]), j.castShadow && (j instanceof THREE.SpotLight || (j instanceof THREE.DirectionalLight && !j.shadowCascade))))
            (i.shadowMap.value[Y] = j.shadowMap), (i.shadowMapSize.value[Y] = j.shadowMapSize), (i.shadowMatrix.value[Y] = j.shadowMatrix), (i.shadowDarkness.value[Y] = j.shadowDarkness), (i.shadowBias.value[Y] = j.shadowBias), Y++;
      }
      b = d.uniformsList;
      i = 0;
      for (Y = b.length; i < Y; i++)
        if ((f = g.uniforms[b[i][1]]))
          if (((c = b[i][0]), (l = c.type), (j = c.value), "i" === l)) k.uniform1i(f, j);
            ...
            l = 0;
            for (m = j.length; l < m; l++) (s = 2 * l), (c._array[s] = j[l].x), (c._array[s + 1] = j[l].y);
          ...
          } else if ("m4" === l) void 0 === c._array && (c._array = new Float32Array(16)), j.flattenToArray(c._array), k.uniformMatrix4fv(f, !1, c._array);
          else if ("m4v" === l) {
            ...
            if (((s = j), (j = I()), k.uniform1i(f, j), s))
              if (s.image instanceof Array && 6 === s.image.length) {
                if (((c = s), (f = j), 6 === c.image.length))
                  if (c.needsUpdate) {
                    c.image.__webglTextureCube || ((c.image.__webglTextureCube = k.createTexture()), D.info.memory.textures++);
                      ...
                      D.autoScaleCubemaps && !f
                        ? ((m = j),
                          ...
                          (t.width <= y && t.height <= y) ||
                            ((z = Math.max(t.width, t.height)), (v = Math.floor((t.width * y) / z)), (y = Math.floor((t.height * y) / z)), (z = document.createElement("canvas")), (z.width = v), (z.height = y), z.getContext("2d").drawImage(t, 0, 0, t.width, t.height, 0, 0, v, y), (t = z)),
                          (m[s] = t))
                        : (j[l] = c.image[l]);
                    l = j[0];
                    ...
                    for (l = 0; 6 > l; l++)
                      if (f) {
                        y = j[l].mipmaps;
                        z = 0;
                        for (B = y.length; z < B; z++) (v = y[z]), k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + l, z, s, v.width, v.height, 0, v.data);
            ...
            l = 0;
            for (m = c.value.length; l < m; l++) (s = c.value[l]), (j = c._array[l]), s && D.setTexture(s, j);
          }
  ...
  function L(a, b, c) {
    ia !== a && (a ? k.enable(k.POLYGON_OFFSET_FILL) : k.disable(k.POLYGON_OFFSET_FILL), (ia = a));
  ...
  function N(a, b, c) {
    c
      ? (k.texParameteri(a, k.TEXTURE_WRAP_S, w(b.wrapS)), k.texParameteri(a, k.TEXTURE_WRAP_T, w(b.wrapT)), k.texParameteri(a, k.TEXTURE_MAG_FILTER, w(b.magFilter)), k.texParameteri(a, k.TEXTURE_MIN_FILTER, w(b.minFilter)))
      : (k.texParameteri(a, k.TEXTURE_WRAP_S, k.CLAMP_TO_EDGE), k.texParameteri(a, k.TEXTURE_WRAP_T, k.CLAMP_TO_EDGE), k.texParameteri(a, k.TEXTURE_MAG_FILTER, M(b.magFilter)), k.texParameteri(a, k.TEXTURE_MIN_FILTER, M(b.minFilter)));
    if (fb && b.type !== THREE.FloatType && (1 < b.anisotropy || b.__oldAnisotropy)) k.texParameterf(a, fb.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(b.anisotropy, Xa)), (b.__oldAnisotropy = b.anisotropy);
  }
  function z(a, b) {
    k.bindRenderbuffer(k.RENDERBUFFER, a);
    b.depthBuffer && !b.stencilBuffer
      ? (k.renderbufferStorage(k.RENDERBUFFER, k.DEPTH_COMPONENT16, b.width, b.height), k.framebufferRenderbuffer(k.FRAMEBUFFER, k.DEPTH_ATTACHMENT, k.RENDERBUFFER, a))
      : b.depthBuffer && b.stencilBuffer
      ? (k.renderbufferStorage(k.RENDERBUFFER, k.DEPTH_STENCIL, b.width, b.height), k.framebufferRenderbuffer(k.FRAMEBUFFER, k.DEPTH_STENCIL_ATTACHMENT, k.RENDERBUFFER, a))
  ...
  function w(a) {
    ...
    if (void 0 !== na) {
      if (a === THREE.RGB_S3TC_DXT1_Format) return na.COMPRESSED_RGB_S3TC_DXT1_EXT;
      if (a === THREE.RGBA_S3TC_DXT1_Format) return na.COMPRESSED_RGBA_S3TC_DXT1_EXT;
      if (a === THREE.RGBA_S3TC_DXT3_Format) return na.COMPRESSED_RGBA_S3TC_DXT3_EXT;
      if (a === THREE.RGBA_S3TC_DXT5_Format) return na.COMPRESSED_RGBA_S3TC_DXT5_EXT;
    }
    return 0;
  }
  ...
  var D = this,
    ...
    na;
  try {
    if (!(k = Z.getContext("experimental-webgl", { alpha: oa, premultipliedAlpha: Pa, antialias: Va, stencil: O, preserveDrawingBuffer: qa }))) throw "Error creating WebGL context.";
  } catch (va) {
    console.error(va);
  }
  ...
  na = k.getExtension("WEBGL_compressed_texture_s3tc") || k.getExtension("MOZ_WEBGL_compressed_texture_s3tc") || k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");
  ...
  na || console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");
  ...
  var Hb = 0 < Kb.precision && 0 < Sb.precision,
    jc = 0 < Ka.precision && 0 < Lb.precision;
  "highp" === K && !Hb && (jc ? ((K = "mediump"), console.warn("WebGLRenderer: highp not supported, using mediump")) : ((K = "lowp"), console.warn("WebGLRenderer: highp and mediump not supported, using lowp")));
  "mediump" === K && !jc && ((K = "lowp"), console.warn("WebGLRenderer: mediump not supported, using lowp"));
  ...
  var kc = function (a) {
      a = a.target;
      a.removeEventListener("dispose", kc);
    ...
    mc = function (a) {
      ...
      if (a && a.__webglTexture)
        if ((k.deleteTexture(a.__webglTexture), a instanceof THREE.WebGLRenderTargetCube)) for (var b = 0; 6 > b; b++) k.deleteFramebuffer(a.__webglFramebuffer[b]), k.deleteRenderbuffer(a.__webglRenderbuffer[b]);
      ...
      if (f instanceof THREE.Mesh)
        if ((d = b.index)) {
          ...
          for (var n = 0, m = e.length; n < m; n++) {
            var p = e[n].index;
            if (c) {
              for (j in b) "index" !== j && ((h = a[j]), (f = b[j]), (l = f.itemSize), 0 <= h && (k.bindBuffer(k.ARRAY_BUFFER, f.buffer), g(h), k.vertexAttribPointer(h, l, k.FLOAT, !1, 0, 4 * p * l)));
              k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, d.buffer);
            }
            k.drawElements(k.TRIANGLES, e[n].count, k.UNSIGNED_SHORT, 2 * e[n].start);
            D.info.render.calls++;
            D.info.render.vertices += e[n].count;
            D.info.render.faces += e[n].count / 3;
          }
        } else {
          if (c) for (j in b) "index" !== j && ((h = a[j]), (f = b[j]), (l = f.itemSize), 0 <= h && (k.bindBuffer(k.ARRAY_BUFFER, f.buffer), g(h), k.vertexAttribPointer(h, l, k.FLOAT, !1, 0, 0)));
          j = e.attributes.position;
          k.drawArrays(k.TRIANGLES, 0, j.numItems / 3);
          D.info.render.calls++;
          D.info.render.vertices += j.numItems / 3;
          D.info.render.faces += j.numItems / 3 / 3;
        }
      else if (f instanceof THREE.ParticleSystem) {
        if (c) {
          for (j in b) (h = a[j]), (f = b[j]), (l = f.itemSize), 0 <= h && (k.bindBuffer(k.ARRAY_BUFFER, f.buffer), g(h), k.vertexAttribPointer(h, l, k.FLOAT, !1, 0, 0));
          j = b.position;
          k.drawArrays(k.POINTS, 0, j.numItems / 3);
          D.info.render.calls++;
          D.info.render.points += j.numItems / 3;
        }
        ...
        D.info.render.calls++;
        D.info.render.points += j.numItems;
      }
    }
  };
    ...
    if (!1 !== d.visible) {
      ...
      if (!d.morphTargets && 0 <= a.position) b && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglVertexBuffer), g(a.position), k.vertexAttribPointer(a.position, 3, k.FLOAT, !1, 0, 0));
        ...
        -1 !== f.morphTargetBase && 0 <= c.position
          ? (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[f.morphTargetBase]), g(c.position), k.vertexAttribPointer(c.position, 3, k.FLOAT, !1, 0, 0))
          : 0 <= c.position && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglVertexBuffer), g(c.position), k.vertexAttribPointer(c.position, 3, k.FLOAT, !1, 0, 0));
        if (f.morphTargetForcedOrder.length) {
          var n = 0;
          j = f.morphTargetForcedOrder;
          for (h = f.morphTargetInfluences; n < d.numSupportedMorphTargets && n < j.length; )
            0 <= c["morphTarget" + n] && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[j[n]]), g(c["morphTarget" + n]), k.vertexAttribPointer(c["morphTarget" + n], 3, k.FLOAT, !1, 0, 0)),
              0 <= c["morphNormal" + n] && d.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[j[n]]), g(c["morphNormal" + n]), k.vertexAttribPointer(c["morphNormal" + n], 3, k.FLOAT, !1, 0, 0)),
          ...
          for (n = 0; n < d.numSupportedMorphTargets; )
            j[n]
              ? ((m = j[n][1]),
                0 <= c["morphTarget" + n] && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[m]), g(c["morphTarget" + n]), k.vertexAttribPointer(c["morphTarget" + n], 3, k.FLOAT, !1, 0, 0)),
                0 <= c["morphNormal" + n] && d.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[m]), g(c["morphNormal" + n]), k.vertexAttribPointer(c["morphNormal" + n], 3, k.FLOAT, !1, 0, 0)),
      ...
      if (b) {
        ...
        0 <= a.normal && (k.bindBuffer(k.ARRAY_BUFFER, e.__webglNormalBuffer), g(a.normal), k.vertexAttribPointer(a.normal, 3, k.FLOAT, !1, 0, 0));
        ...
        d.skinning &&
          0 <= a.skinIndex &&
          0 <= a.skinWeight &&
          (k.bindBuffer(k.ARRAY_BUFFER, e.__webglSkinIndicesBuffer), g(a.skinIndex), k.vertexAttribPointer(a.skinIndex, 4, k.FLOAT, !1, 0, 0), k.bindBuffer(k.ARRAY_BUFFER, e.__webglSkinWeightsBuffer), g(a.skinWeight), k.vertexAttribPointer(a.skinWeight, 4, k.FLOAT, !1, 0, 0));
      ...
      f instanceof THREE.Mesh
        ? (d.wireframe ? (B(d.wireframeLinewidth), b && k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, e.__webglLineBuffer), k.drawElements(k.LINES, e.__webglLineCount, k.UNSIGNED_SHORT, 0)) : (b && k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, e.__webglFaceBuffer), k.drawElements(k.TRIANGLES, e.__webglFaceCount, k.UNSIGNED_SHORT, 0)),
          D.info.render.calls++,
          (D.info.render.vertices += e.__webglFaceCount),
          (D.info.render.faces += e.__webglFaceCount / 3))
        : f instanceof THREE.Line
        ? ((f = f.type === THREE.LineStrip ? k.LINE_STRIP : k.LINES), B(d.linewidth), k.drawArrays(f, 0, e.__webglLineCount), D.info.render.calls++)
        : f instanceof THREE.ParticleSystem
        ? (k.drawArrays(k.POINTS, 0, e.__webglParticleCount), D.info.render.calls++, (D.info.render.points += e.__webglParticleCount))
        : f instanceof THREE.Ribbon && (k.drawArrays(k.TRIANGLE_STRIP, 0, e.__webglVertexCount), D.info.render.calls++);
    }
  };
    ...
    if (!1 === b instanceof THREE.Camera) console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
      ...
      for (e = g.length; d < e; d++)
        if (((f = g[d]), (h = f.object), (f.id = d), (f.render = !1), h.visible && (!(h instanceof THREE.Mesh || h instanceof THREE.ParticleSystem) || !h.frustumCulled || Sa.intersectsObject(h)))) {
          var p = h;
          p._modelViewMatrix.multiplyMatrices(b.matrixWorldInverse, p.matrixWorld);
          ...
          var p = f,
            ...
            t = (r = void 0),
            t = p.object.material;
          if (t instanceof THREE.MeshFaceMaterial) (r = s.materialIndex), (r = t.materials[r]), r.transparent ? ((p.transparent = r), (p.opaque = null)) : ((p.opaque = r), (p.transparent = null));
          else if ((r = t)) r.transparent ? ((p.transparent = r), (p.opaque = null)) : ((p.opaque = r), (p.transparent = null));
          f.render = !0;
      ...
      a.overrideMaterial
        ? ((d = a.overrideMaterial),
          ...
          L(d.polygonOffset, d.polygonOffsetFactor, d.polygonOffsetUnits),
          m(a.__webglObjects, !1, "", b, i, l, !0, d),
          q(a.__webglObjectsImmediate, "", b, i, l, !1, d))
        : ((d = null), this.setBlending(THREE.NoBlending), m(a.__webglObjects, !0, "opaque", b, i, l, !1, d), q(a.__webglObjectsImmediate, "opaque", b, i, l, !1, d), m(a.__webglObjects, !1, "transparent", b, i, l, !0, d), q(a.__webglObjectsImmediate, "transparent", b, i, l, !0, d));
      n(this.renderPluginsPost, a, b);
      c &&
        c.generateMipmaps &&
        c.minFilter !== THREE.NearestFilter &&
        c.minFilter !== THREE.LinearFilter &&
        (c instanceof THREE.WebGLRenderTargetCube ? (k.bindTexture(k.TEXTURE_CUBE_MAP, c.__webglTexture), k.generateMipmap(k.TEXTURE_CUBE_MAP), k.bindTexture(k.TEXTURE_CUBE_MAP, null)) : (k.bindTexture(k.TEXTURE_2D, c.__webglTexture), k.generateMipmap(k.TEXTURE_2D), k.bindTexture(k.TEXTURE_2D, null)));
      this.setDepthTest(!0);
    ...
    for (var b = 0, c = a.__webglObjects.length; b < c; b++) {
      ...
      if (j instanceof THREE.BufferGeometry) {
        var r = k.DYNAMIC_DRAW,
          ...
          z = void 0,
          B = void 0;
        for (z in w) (B = w[z]), B.needsUpdate && ("index" === z ? (k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, B.buffer), k.bufferData(k.ELEMENT_ARRAY_BUFFER, B.array, r)) : (k.bindBuffer(k.ARRAY_BUFFER, B.buffer), k.bufferData(k.ARRAY_BUFFER, B.array, r)), (B.needsUpdate = !1)), y && !B.dynamic && delete B.array;
      } else if (i instanceof THREE.Mesh) {
        for (var C = 0, G = j.geometryGroupsList.length; C < G; C++)
          if (((n = j.geometryGroupsList[C]), (q = e(i, n)), j.buffersNeedUpdate && d(n, i), (m = q.attributes && p(q)), j.verticesNeedUpdate || j.morphTargetsNeedUpdate || j.elementsNeedUpdate || j.uvsNeedUpdate || j.normalsNeedUpdate || j.colorsNeedUpdate || j.tangentsNeedUpdate || m)) {
            var A = n,
              H = i,
              F = k.DYNAMIC_DRAW,
              I = !j.dynamic,
            ...
            if (A.__inittedArrays) {
              var K = f(J),
                V = J.vertexColors ? J.vertexColors : !1,
                L = h(J),
                ...
                La = A.__tangentArray,
                eb = A.__colorArray,
                Ma = A.__skinIndexArray,
                Na = A.__skinWeightArray,
                yb = A.__morphTargetsArrays,
                Ab = A.__morphNormalsArrays,
                Bb = A.__webglCustomAttributesList,
                u = void 0,
                Mb = A.__faceArray,
                wb = A.__lineArray,
                qb = H.geometry,
              ...
              if (qb.verticesNeedUpdate) {
                E = 0;
                for (D = sa.length; E < D; E++) (Q = kb[sa[E]]), (R = cc[Q.a]), (S = cc[Q.b]), (P = cc[Q.c]), (db[Za] = R.x), (db[Za + 1] = R.y), (db[Za + 2] = R.z), (db[Za + 3] = S.x), (db[Za + 4] = S.y), (db[Za + 5] = S.z), (db[Za + 6] = P.x), (db[Za + 7] = P.y), (db[Za + 8] = P.z), (Za += 9);
                E = 0;
                ...
                k.bufferData(k.ARRAY_BUFFER, db, F);
              }
              if (Yb) {
                cb = 0;
                for (bb = ac.length; cb < bb; cb++) {
                  ...
                  for (D = sa.length; E < D; E++)
                    (Va = sa[E]),
                      ...
                      ($a[ga + 8] = P.z),
                      J.morphNormals &&
                        (M ? ((Qa = Ib[cb].vertexNormals[Va]), (Ha = Qa.a), (ha = Qa.b), (Ua = Qa.c)) : (Ua = ha = Ha = Ib[cb].faceNormals[Va]),
                        (ab = Ab[cb]),
                        (ab[ga] = Ha.x),
                        (ab[ga + 1] = Ha.y),
                        (ab[ga + 2] = Ha.z),
                  ...
                  for (D = ta.length; E < D; E++)
                    (Va = ta[E]),
                      ...
                      ($a[ga + 11] = ba.z),
                      J.morphNormals &&
                        (M ? ((Qa = Ib[cb].vertexNormals[Va]), (Ha = Qa.a), (ha = Qa.b), (Ua = Qa.c), (qa = Qa.d)) : (qa = Ua = ha = Ha = Ib[cb].faceNormals[Va]),
                        (ab = Ab[cb]),
                        (ab[ga] = Ha.x),
                        (ab[ga + 1] = Ha.y),
                        (ab[ga + 2] = Ha.z),
                        ...
                        (ab[ga + 11] = qa.z)),
                      (ga += 12);
                  k.bindBuffer(k.ARRAY_BUFFER, A.__webglMorphTargetsBuffers[cb]);
                  k.bufferData(k.ARRAY_BUFFER, yb[cb], F);
                  J.morphNormals && (k.bindBuffer(k.ARRAY_BUFFER, A.__webglMorphNormalsBuffers[cb]), k.bufferData(k.ARRAY_BUFFER, Ab[cb], F));
                }
              }
              if ($b.length) {
                E = 0;
                ...
                for (D = ta.length; E < D; E++)
                  (Q = kb[ta[E]]),
                    ...
                    (Ma[X + 15] = pb.w),
                    (X += 16);
                0 < X && (k.bindBuffer(k.ARRAY_BUFFER, A.__webglSkinIndicesBuffer), k.bufferData(k.ARRAY_BUFFER, Ma, F), k.bindBuffer(k.ARRAY_BUFFER, A.__webglSkinWeightsBuffer), k.bufferData(k.ARRAY_BUFFER, Na, F));
              }
              if (Xb && V) {
                E = 0;
                for (D = sa.length; E < D; E++)
                  (Q = kb[sa[E]]),
                    (T = Q.vertexColors),
                    (Y = Q.color),
                    3 === T.length && V === THREE.VertexColors ? ((la = T[0]), (ia = T[1]), (ka = T[2])) : (ka = ia = la = Y),
                    (eb[Wa] = la.r),
                    (eb[Wa + 1] = la.g),
                    (eb[Wa + 2] = la.b),
                    (eb[Wa + 3] = ia.r),
                ...
                for (D = ta.length; E < D; E++)
                  (Q = kb[ta[E]]),
                    (T = Q.vertexColors),
                    (Y = Q.color),
                    4 === T.length && V === THREE.VertexColors ? ((la = T[0]), (ia = T[1]), (ka = T[2]), (ua = T[3])) : (ua = ka = ia = la = Y),
                    (eb[Wa] = la.r),
                    (eb[Wa + 1] = la.g),
                    (eb[Wa + 2] = la.b),
                    (eb[Wa + 3] = ia.r),
                    ...
                    (eb[Wa + 11] = ua.b),
                    (Wa += 12);
                0 < Wa && (k.bindBuffer(k.ARRAY_BUFFER, A.__webglColorBuffer), k.bufferData(k.ARRAY_BUFFER, eb, F));
              }
              if (Sb && qb.hasTangents) {
                ...
                for (D = ta.length; E < D; E++)
                  (Q = kb[ta[E]]),
                    ...
                    (La[Da + 15] = ma.w),
                    (Da += 16);
                k.bindBuffer(k.ARRAY_BUFFER, A.__webglTangentBuffer);
                k.bufferData(k.ARRAY_BUFFER, La, F);
              }
              if (Rb && K) {
                E = 0;
                for (D = sa.length; E < D; E++)
                  if (((Q = kb[sa[E]]), (O = Q.vertexNormals), (ea = Q.normal), 3 === O.length && M)) for (za = 0; 3 > za; za++) (Fa = O[za]), (Sa[jb] = Fa.x), (Sa[jb + 1] = Fa.y), (Sa[jb + 2] = Fa.z), (jb += 3);
                  else for (za = 0; 3 > za; za++) (Sa[jb] = ea.x), (Sa[jb + 1] = ea.y), (Sa[jb + 2] = ea.z), (jb += 3);
                E = 0;
                for (D = ta.length; E < D; E++)
                  if (((Q = kb[ta[E]]), (O = Q.vertexNormals), (ea = Q.normal), 4 === O.length && M)) for (za = 0; 4 > za; za++) (Fa = O[za]), (Sa[jb] = Fa.x), (Sa[jb + 1] = Fa.y), (Sa[jb + 2] = Fa.z), (jb += 3);
                  else for (za = 0; 4 > za; za++) (Sa[jb] = ea.x), (Sa[jb + 1] = ea.y), (Sa[jb + 2] = ea.z), (jb += 3);
                k.bindBuffer(k.ARRAY_BUFFER, A.__webglNormalBuffer);
                k.bufferData(k.ARRAY_BUFFER, Sa, F);
              }
              if (Hb && Jb && L) {
                E = 0;
                for (D = sa.length; E < D; E++) if (((N = sa[E]), (fa = Jb[N]), void 0 !== fa)) for (za = 0; 3 > za; za++) (Pa = fa[za]), (fb[Xa] = Pa.x), (fb[Xa + 1] = Pa.y), (Xa += 2);
                E = 0;
                for (D = ta.length; E < D; E++) if (((N = ta[E]), (fa = Jb[N]), void 0 !== fa)) for (za = 0; 4 > za; za++) (Pa = fa[za]), (fb[Xa] = Pa.x), (fb[Xa + 1] = Pa.y), (Xa += 2);
                0 < Xa && (k.bindBuffer(k.ARRAY_BUFFER, A.__webglUVBuffer), k.bufferData(k.ARRAY_BUFFER, fb, F));
              }
              if (Hb && Lb && L) {
                E = 0;
                for (D = sa.length; E < D; E++) if (((N = sa[E]), (aa = Lb[N]), void 0 !== aa)) for (za = 0; 3 > za; za++) (Ra = aa[za]), (ib[Ya] = Ra.x), (ib[Ya + 1] = Ra.y), (Ya += 2);
                E = 0;
                for (D = ta.length; E < D; E++) if (((N = ta[E]), (aa = Lb[N]), void 0 !== aa)) for (za = 0; 4 > za; za++) (Ra = aa[za]), (ib[Ya] = Ra.x), (ib[Ya + 1] = Ra.y), (Ya += 2);
                0 < Ya && (k.bindBuffer(k.ARRAY_BUFFER, A.__webglUV2Buffer), k.bufferData(k.ARRAY_BUFFER, ib, F));
              }
              if (Gb) {
                E = 0;
                ...
                for (D = ta.length; E < D; E++)
                  (Mb[Ka] = Ta),
                    ...
                    (ob += 8),
                    (Ta += 4);
                k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, A.__webglFaceBuffer);
                k.bufferData(k.ELEMENT_ARRAY_BUFFER, Mb, F);
                k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, A.__webglLineBuffer);
                k.bufferData(k.ELEMENT_ARRAY_BUFFER, wb, F);
              }
              if (Bb) {
                za = 0;
                for (ub = Bb.length; za < ub; za++)
                  if (((u = Bb[za]), u.__original.needsUpdate)) {
                    ...
                    if (1 === u.size)
                      if (void 0 === u.boundTo || "vertices" === u.boundTo) {
                        ...
                        if ("faces" === u.boundTo) {
                          ...
                          E = 0;
                          for (D = ta.length; E < D; E++) (Aa = u.value[ta[E]]), (u.array[x] = Aa), (u.array[x + 1] = Aa), (u.array[x + 2] = Aa), (u.array[x + 3] = Aa), (x += 4);
                        }
                      }
                    else if (2 === u.size)
                      if (void 0 === u.boundTo || "vertices" === u.boundTo) {
                    ...
                    k.bufferData(k.ARRAY_BUFFER, u.array, F);
                  }
              }
              I && (delete A.__inittedArrays, delete A.__colorArray, delete A.__normalArray, delete A.__tangentArray, delete A.__uvArray, delete A.__uv2Array, delete A.__faceArray, delete A.__vertexArray, delete A.__lineArray, delete A.__skinIndexArray, delete A.__skinWeightArray);
            }
          }
        ...
        q = e(i, j);
        m = q.attributes && p(q);
        if (j.verticesNeedUpdate || j.colorsNeedUpdate || j.normalsNeedUpdate || m) {
          var Cb = j,
            Kb = k.DYNAMIC_DRAW,
            nc = void 0,
            oc = void 0,
          ...
          if (Cb.verticesNeedUpdate) {
            for (nc = 0; nc < uc; nc++) (Tb = kc[nc]), (Ba = 3 * nc), (zc[Ba] = Tb.x), (zc[Ba + 1] = Tb.y), (zc[Ba + 2] = Tb.z);
          ...
          if (Lc) {
            yc = 0;
            for (jc = Lc.length; yc < jc; yc++)
              if (((Ia = Lc[yc]), Ia.needsUpdate && (void 0 === Ia.boundTo || "vertices" === Ia.boundTo))) {
                Ba = 0;
                gc = Ia.value.length;
                if (1 === Ia.size) for (gb = 0; gb < gc; gb++) Ia.array[gb] = Ia.value[gb];
                else if (2 === Ia.size) for (gb = 0; gb < gc; gb++) (rb = Ia.value[gb]), (Ia.array[Ba] = rb.x), (Ia.array[Ba + 1] = rb.y), (Ba += 2);
                else if (3 === Ia.size)
                  if ("c" === Ia.type) for (gb = 0; gb < gc; gb++) (rb = Ia.value[gb]), (Ia.array[Ba] = rb.r), (Ia.array[Ba + 1] = rb.g), (Ia.array[Ba + 2] = rb.b), (Ba += 3);
                  else for (gb = 0; gb < gc; gb++) (rb = Ia.value[gb]), (Ia.array[Ba] = rb.x), (Ia.array[Ba + 1] = rb.y), (Ia.array[Ba + 2] = rb.z), (Ba += 3);
                else if (4 === Ia.size) for (gb = 0; gb < gc; gb++) (rb = Ia.value[gb]), (Ia.array[Ba] = rb.x), (Ia.array[Ba + 1] = rb.y), (Ia.array[Ba + 2] = rb.z), (Ia.array[Ba + 3] = rb.w), (Ba += 4);
        ...
        q = e(i, j);
        m = q.attributes && p(q);
        if (j.verticesNeedUpdate || j.colorsNeedUpdate || j.lineDistancesNeedUpdate || m) {
          var Db = j,
            Cc = k.DYNAMIC_DRAW,
            qc = void 0,
            rc = void 0,
          ...
          if (Mc) {
            ...
            for (Uc = Mc.length; Hc < Uc; Hc++)
              if (((Ja = Mc[Hc]), Ja.needsUpdate && (void 0 === Ja.boundTo || "vertices" === Ja.boundTo))) {
                Oa = 0;
                hc = Ja.value.length;
                if (1 === Ja.size) for (hb = 0; hb < hc; hb++) Ja.array[hb] = Ja.value[hb];
                else if (2 === Ja.size) for (hb = 0; hb < hc; hb++) (sb = Ja.value[hb]), (Ja.array[Oa] = sb.x), (Ja.array[Oa + 1] = sb.y), (Oa += 2);
                else if (3 === Ja.size)
                  if ("c" === Ja.type) for (hb = 0; hb < hc; hb++) (sb = Ja.value[hb]), (Ja.array[Oa] = sb.r), (Ja.array[Oa + 1] = sb.g), (Ja.array[Oa + 2] = sb.b), (Oa += 3);
                  else for (hb = 0; hb < hc; hb++) (sb = Ja.value[hb]), (Ja.array[Oa] = sb.x), (Ja.array[Oa + 1] = sb.y), (Ja.array[Oa + 2] = sb.z), (Oa += 3);
                else if (4 === Ja.size) for (hb = 0; hb < hc; hb++) (sb = Ja.value[hb]), (Ja.array[Oa] = sb.x), (Ja.array[Oa + 1] = sb.y), (Ja.array[Oa + 2] = sb.z), (Ja.array[Oa + 3] = sb.w), (Oa += 4);
        ...
        q = e(i, j);
        m = q.attributes && p(q);
        if (j.verticesNeedUpdate || j.colorsNeedUpdate || i.sortParticles || m) {
          var Nb = j,
            Nc = k.DYNAMIC_DRAW,
            tc = i,
            tb = void 0,
          ...
          if (tc.sortParticles) {
            ...
            if (Wb) {
              Eb = 0;
              for (ic = Wb.length; Eb < ic; Eb++)
                if ((($ = Wb[Eb]), void 0 === $.boundTo || "vertices" === $.boundTo))
                  if (((ca = 0), (Fb = $.value.length), 1 === $.size)) for (ja = 0; ja < Fb; ja++) (Qb = Vb[ja][1]), ($.array[ja] = $.value[Qb]);
                  else if (2 === $.size) for (ja = 0; ja < Fb; ja++) (Qb = Vb[ja][1]), (Ea = $.value[Qb]), ($.array[ca] = Ea.x), ($.array[ca + 1] = Ea.y), (ca += 2);
                  else if (3 === $.size)
                    if ("c" === $.type) for (ja = 0; ja < Fb; ja++) (Qb = Vb[ja][1]), (Ea = $.value[Qb]), ($.array[ca] = Ea.r), ($.array[ca + 1] = Ea.g), ($.array[ca + 2] = Ea.b), (ca += 3);
                    else for (ja = 0; ja < Fb; ja++) (Qb = Vb[ja][1]), (Ea = $.value[Qb]), ($.array[ca] = Ea.x), ($.array[ca + 1] = Ea.y), ($.array[ca + 2] = Ea.z), (ca += 3);
                  else if (4 === $.size) for (ja = 0; ja < Fb; ja++) (Qb = Vb[ja][1]), (Ea = $.value[Qb]), ($.array[ca] = Ea.x), ($.array[ca + 1] = Ea.y), ($.array[ca + 2] = Ea.z), ($.array[ca + 3] = Ea.w), (ca += 4);
            }
          } else {
            ...
            if (Wb) {
              ...
              for (ic = Wb.length; Eb < ic; Eb++)
                if ((($ = Wb[Eb]), $.needsUpdate && (void 0 === $.boundTo || "vertices" === $.boundTo)))
                  if (((Fb = $.value.length), (ca = 0), 1 === $.size)) for (ja = 0; ja < Fb; ja++) $.array[ja] = $.value[ja];
                  else if (2 === $.size) for (ja = 0; ja < Fb; ja++) (Ea = $.value[ja]), ($.array[ca] = Ea.x), ($.array[ca + 1] = Ea.y), (ca += 2);
                  else if (3 === $.size)
                    if ("c" === $.type) for (ja = 0; ja < Fb; ja++) (Ea = $.value[ja]), ($.array[ca] = Ea.r), ($.array[ca + 1] = Ea.g), ($.array[ca + 2] = Ea.b), (ca += 3);
                    else for (ja = 0; ja < Fb; ja++) (Ea = $.value[ja]), ($.array[ca] = Ea.x), ($.array[ca + 1] = Ea.y), ($.array[ca + 2] = Ea.z), (ca += 3);
                  else if (4 === $.size) for (ja = 0; ja < Fb; ja++) (Ea = $.value[ja]), ($.array[ca] = Ea.x), ($.array[ca + 1] = Ea.y), ($.array[ca + 2] = Ea.z), ($.array[ca + 3] = Ea.w), (ca += 4);
            }
          }
          if (Wc || tc.sortParticles) k.bindBuffer(k.ARRAY_BUFFER, Nb.__webglVertexBuffer), k.bufferData(k.ARRAY_BUFFER, ec, Nc);
          if (Xc || tc.sortParticles) k.bindBuffer(k.ARRAY_BUFFER, Nb.__webglColorBuffer), k.bufferData(k.ARRAY_BUFFER, fc, Nc);
          if (Wb) {
            Eb = 0;
            for (ic = Wb.length; Eb < ic; Eb++) if ((($ = Wb[Eb]), $.needsUpdate || tc.sortParticles)) k.bindBuffer(k.ARRAY_BUFFER, $.buffer), k.bufferData(k.ARRAY_BUFFER, $.array, Nc);
          }
        }
        j.verticesNeedUpdate = !1;
        j.colorsNeedUpdate = !1;
  ...
  this.initMaterial = function (a, b, c, d) {
    ...
    var q, s, r;
    e = h = s = r = p = 0;
    for (f = b.length; e < f; e++) (q = b[e]), q.onlyShadow || (q instanceof THREE.DirectionalLight && h++, q instanceof THREE.PointLight && s++, q instanceof THREE.SpotLight && r++, q instanceof THREE.HemisphereLight && p++);
    e = h;
    f = s;
    h = r;
    g = p;
    ...
    Bb && d && d.useVertexTexture
      ...
      : ((b = k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS)),
        (b = Math.floor((b - 20) / 4)),
        void 0 !== d && d instanceof THREE.SkinnedMesh && ((b = Math.min(d.bones.length, b)), b < d.bones.length && console.warn("WebGLRenderer: too many bones - " + d.bones.length + ", this GPU supports just " + b + " (try OpenGL instead of ANGLE)")),
        (l = b));
    a: {
      r = a.fragmentShader;
      s = a.vertexShader;
      ...
      k.attachShader(y, t);
      k.linkProgram(y);
      k.getProgramParameter(y, k.LINK_STATUS) || console.error("Could not initialise shader\nVALIDATE_STATUS: " + k.getProgramParameter(y, k.VALIDATE_STATUS) + ", gl error [" + k.getError() + "]");
      k.deleteShader(t);
      k.deleteShader(v);
      y.uniforms = {};
      y.attributes = {};
      ...
      w = t;
      t = 0;
      for (v = w.length; t < v; t++) (p = w[t]), (y.uniforms[p] = k.getUniformLocation(y, p));
      ...
      j = t;
      w = 0;
      for (b = j.length; w < b; w++) (t = j[w]), (y.attributes[t] = k.getAttribLocation(y, t));
      y.id = ea++;
      V.push({ program: y, code: m, usedTimes: 1 });
    ...
    if (a.morphTargets) {
      ...
      b = "morphTarget";
      for (j = 0; j < this.maxMorphTargets; j++) (y = b + j), 0 <= w[y] && a.numSupportedMorphTargets++;
    }
    if (a.morphNormals) {
      a.numSupportedMorphNormals = 0;
      b = "morphNormal";
      for (j = 0; j < this.maxMorphNormals; j++) (y = b + j), 0 <= w[y] && a.numSupportedMorphNormals++;
    }
    a.uniformsList = [];
  ...
  this.setBlending = function (a, b, c, d) {
    a !== aa &&
      (a === THREE.NoBlending
        ...
        ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.ZERO, k.ONE_MINUS_SRC_COLOR))
        : a === THREE.MultiplyBlending
        ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.ZERO, k.SRC_COLOR))
        : a === THREE.CustomBlending
        ? k.enable(k.BLEND)
        : (k.enable(k.BLEND), k.blendEquationSeparate(k.FUNC_ADD, k.FUNC_ADD), k.blendFuncSeparate(k.SRC_ALPHA, k.ONE_MINUS_SRC_ALPHA, k.ONE, k.ONE_MINUS_SRC_ALPHA)),
      (aa = a));
    if (a === THREE.CustomBlending) {
      if ((b !== la && (k.blendEquation(w(b)), (la = b)), c !== Y || d !== ma)) k.blendFunc(w(c), w(d)), (Y = c), (ma = d);
    } else ma = Y = la = null;
  };
  this.setTexture = function (a, b) {
    if (a.needsUpdate) {
      a.__webglInit || ((a.__webglInit = !0), a.addEventListener("dispose", lc), (a.__webglTexture = k.createTexture()), D.info.memory.textures++);
      ...
      if (a instanceof THREE.DataTexture)
        ...
        g = 0;
        for (i = h.length; g < i; g++) (c = h[g]), k.texImage2D(k.TEXTURE_2D, g, e, e, f, c);
        a.generateMipmaps = !1;
  ...
  this.setRenderTarget = function (a) {
    ...
    if (a && !a.__webglFramebuffer) {
      ...
      if (b) {
        ...
        (a.__webglFramebuffer = k.createFramebuffer()),
          (a.__webglRenderbuffer = a.shareDepthFrom ? a.shareDepthFrom.__webglRenderbuffer : k.createRenderbuffer()),
          k.bindTexture(k.TEXTURE_2D, a.__webglTexture),
          N(k.TEXTURE_2D, a, c),
          ...
          a.shareDepthFrom
            ? a.depthBuffer && !a.stencilBuffer
              ? k.framebufferRenderbuffer(k.FRAMEBUFFER, k.DEPTH_ATTACHMENT, k.RENDERBUFFER, a.__webglRenderbuffer)
              : a.depthBuffer && a.stencilBuffer && k.framebufferRenderbuffer(k.FRAMEBUFFER, k.DEPTH_STENCIL_ATTACHMENT, k.RENDERBUFFER, a.__webglRenderbuffer)
    ...
    a ? ((b = b ? a.__webglFramebuffer[a.activeCubeFace] : a.__webglFramebuffer), (c = a.width), (a = a.height), (e = d = 0)) : ((b = null), (c = Qa), (a = Ya), (d = ua), (e = Ra));
    b !== Ua && (k.bindFramebuffer(k.FRAMEBUFFER, b), k.viewport(d, e, c, a), (Ua = b));
    Xb = c;
    Jb = a;
  };
...
THREE.GeometryUtils = {
  merge: function (a, b, c) {
    ...
    for (n = l.length; b < n; b++) {
      var m = l[b],
        ...
        r = m.vertexNormals,
        p = m.vertexColors;
      m instanceof THREE.Face3 ? (q = new THREE.Face3(m.a + f, m.b + f, m.c + f)) : m instanceof THREE.Face4 && (q = new THREE.Face4(m.a + f, m.b + f, m.c + f, m.d + f));
      q.normal.copy(m.normal);
      e && q.normal.applyMatrix3(e).normalize();
      g = 0;
      for (i = r.length; g < i; g++) (t = r[g].clone()), e && t.applyMatrix3(e).normalize(), q.vertexNormals.push(t);
      q.color.copy(m.color);
      g = 0;
      for (i = p.length; g < i; g++) (t = p[g]), q.vertexColors.push(t.clone());
  ...
  randomPointsInGeometry: function (a, b) {
    ...
    for (e = 0; e < g; e++)
      (d = f[e]),
        d instanceof THREE.Face3
          ? ((l = h[d.a]), (n = h[d.b]), (m = h[d.c]), (d._area = THREE.GeometryUtils.triangleArea(l, n, m)))
          : d instanceof THREE.Face4 && ((l = h[d.a]), (n = h[d.b]), (m = h[d.c]), (q = h[d.d]), (d._area1 = THREE.GeometryUtils.triangleArea(l, n, q)), (d._area2 = THREE.GeometryUtils.triangleArea(n, m, q)), (d._area = d._area1 + d._area2)),
        (i += d._area),
        (j[e] = i);
    d = [];
    for (e = 0; e < b; e++) (h = THREE.GeometryUtils.random() * i), (h = c(h)), (d[e] = THREE.GeometryUtils.randomPointInFace(f[h], a, !0));
    return d;
  },
    ...
    for (c = a.faces.length; b < c; b++)
      if (((d = a.faces[b]), d instanceof THREE.Face4)) {
        ...
        4 === d.vertexColors.length &&
          ((n.vertexColors[0] = d.vertexColors[0].clone()), (n.vertexColors[1] = d.vertexColors[1].clone()), (n.vertexColors[2] = d.vertexColors[3].clone()), (m.vertexColors[0] = d.vertexColors[1].clone()), (m.vertexColors[1] = d.vertexColors[2].clone()), (m.vertexColors[2] = d.vertexColors[3].clone()));
        f.push(n, m);
        d = 0;
        for (e = a.faceVertexUvs.length; d < e; d++) a.faceVertexUvs[d].length && ((n = a.faceVertexUvs[d][b]), (i = n[1]), (j = n[2]), (l = n[3]), (n = [n[0].clone(), i.clone(), l.clone()]), (i = [i.clone(), j.clone(), l.clone()]), g[d].push(n, i));
        d = 0;
  ...
  getNormalMap: function (a, b) {
    ...
    for (var g = h.getImageData(0, 0, d, e).data, i = h.createImageData(d, e), j = i.data, l = 0; l < d; l++)
      for (var n = 0; n < e; n++) {
        ...
        p.push([-1, 0, (g[4 * (n * d + t)] / 255) * b]);
        p.push([-1, -1, (g[4 * (m * d + t)] / 255) * b]);
        p.push([0, -1, (g[4 * (m * d + l)] / 255) * b]);
        p.push([1, -1, (g[4 * (m * d + r)] / 255) * b]);
        p.push([1, 0, (g[4 * (n * d + r)] / 255) * b]);
        p.push([1, 1, (g[4 * (q * d + r)] / 255) * b]);
        p.push([0, 1, (g[4 * (q * d + l)] / 255) * b]);
        p.push([-1, 1, (g[4 * (q * d + t)] / 255) * b]);
        m = [];
        t = p.length;
        for (q = 0; q < t; q++) {
          var r = p[q],
        ...
        p = [0, 0, 0];
        for (q = 0; q < m.length; q++) (p[0] += m[q][0]), (p[1] += m[q][1]), (p[2] += m[q][2]);
        p[0] /= m.length;
        p[1] /= m.length;
        p[2] /= m.length;
        s = 4 * (n * d + l);
        ...
        for (a = 0; a < j; )
          switch (((i = b[a++]), i)) {
            ...
            case "q":
              ...
              break;
            case "b":
              if (((i = b[a++] * c + d), (l = b[a++] * c), (q = b[a++] * c + d), (t = b[a++] * -c), (r = b[a++] * c + d), (p = b[a++] * -c), e.bezierCurveTo(i, l, q, t, r, p), (h = f[f.length - 1]))) {
                n = h.x;
                m = h.y;
                h = 1;
                for (g = this.divisions; h <= g; h++) (v = h / g), THREE.Shape.Utils.b3(v, n, q, r, i), THREE.Shape.Utils.b3(v, m, t, p, l);
              }
          }
      }
    ...
    for (j = e - 1; 2 < e; ) {
      ...
      a: {
        ...
        if (1e-10 > (r - q) * (v - t) - (p - t) * (s - q)) m = !1;
          ...
          for (m = 0; m < e; m++)
            if (!(m === i || m === j || m === l))
              if (((y = a[h[m]].x), (G = a[h[m]].y), (C = y - q), (J = G - t), (N = y - r), (z = G - p), (y -= s), (G -= v), (N = H * z - I * N), (C = B * J - L * C), (J = F * G - A * y), 0 <= N && 0 <= J && 0 <= C)) {
                m = !1;
                break a;
              }
          m = !0;
...
THREE.CurvePath.prototype.getBoundingBox = function () {
  ...
  i = 0;
  for (j = a.length; i < j; i++) (g = a[i]), g.x > b ? (b = g.x) : g.x < e && (e = g.x), g.y > c ? (c = g.y) : g.y < f && (f = g.y), n && (g.z > d ? (d = g.z) : g.z < h && (h = g.z)), l.add(g);
  ...
  for (e = this.actions.length; d < e; d++)
    switch (((f = this.actions[d]), (h = f.action), (f = f.args), h)) {
      ...
      case THREE.PathActions.QUADRATIC_CURVE_TO:
        ...
        n = f[0];
        m = f[1];
        0 < c.length ? ((h = c[c.length - 1]), (q = h.x), (t = h.y)) : ((h = this.actions[d - 1].args), (q = h[h.length - 2]), (t = h[h.length - 1]));
        for (f = 1; f <= a; f++) (r = f / a), (h = THREE.Shape.Utils.b2(r, q, n, g)), (r = THREE.Shape.Utils.b2(r, t, m, i)), c.push(new THREE.Vector2(h, r));
        break;
      case THREE.PathActions.BEZIER_CURVE_TO:
        ...
        l = f[3];
        0 < c.length ? ((h = c[c.length - 1]), (q = h.x), (t = h.y)) : ((h = this.actions[d - 1].args), (q = h[h.length - 2]), (t = h[h.length - 1]));
        for (f = 1; f <= a; f++) (r = f / a), (h = THREE.Shape.Utils.b3(r, q, n, j, g)), (r = THREE.Shape.Utils.b3(r, t, m, l, i)), c.push(new THREE.Vector2(h, r));
        break;
      case THREE.PathActions.CSPLINE_THRU:
        h = this.actions[d - 1].args;
        r = [new THREE.Vector2(h[h.length - 2], h[h.length - 1])];
        h = a * f[0].length;
        r = r.concat(f[0]);
        r = new THREE.SplineCurve(r);
        for (f = 1; f <= h; f++) c.push(r.getPointAt(f / h));
        break;
      case THREE.PathActions.ARC:
        ...
        q = h - j;
        t = 2 * a;
        for (f = 1; f <= t; f++) (r = f / t), n || (r = 1 - r), (r = j + r * q), (h = g + m * Math.cos(r)), (r = i + m * Math.sin(r)), c.push(new THREE.Vector2(h, r));
        break;
      case THREE.PathActions.ELLIPSE:
        ...
        q = h - j;
        t = 2 * a;
        for (f = 1; f <= t; f++) (r = f / t), n || (r = 1 - r), (r = j + r * q), (h = g + m * Math.cos(r)), (r = i + l * Math.sin(r)), c.push(new THREE.Vector2(h, r));
    }
  d = c[c.length - 1];
...
THREE.Path.prototype.toShapes = function () {
  ...
  if (1 == e.length) return (f = e[0]), (h = new THREE.Shape()), (h.actions = f.actions), (h.curves = f.curves), d.push(h), d;
  if (a) {
    h = new THREE.Shape();
    a = 0;
    for (b = e.length; a < b; a++) (f = e[a]), THREE.Shape.Utils.isClockWise(f.getPoints()) ? ((h.actions = f.actions), (h.curves = f.curves), d.push(h), (h = new THREE.Shape())) : h.holes.push(f);
  } else {
    a = 0;
    for (b = e.length; a < b; a++) (f = e[a]), THREE.Shape.Utils.isClockWise(f.getPoints()) ? (h && d.push(h), (h = new THREE.Shape()), (h.actions = f.actions), (h.curves = f.curves)) : h.holes.push(f);
    d.push(h);
  }
  return d;
};
  ...
  removeHoles: function (a, b) {
    ...
    for (i = 0; i < b.length; i++) {
      ...
      for (e = 0; e < j.length; e++) {
        m = j[e];
        q = [];
        for (n = 0; n < c.length; n++) (l = c[n]), (l = m.distanceToSquared(l)), q.push(l), l < f && ((f = l), (h = e), (g = n));
      }
      ...
      n + m > r + p && ((g = q), (h = l), 0 > g && (g += c.length), (g %= c.length), 0 > h && (h += j.length), (h %= j.length), (e = 0 <= g - 1 ? g - 1 : c.length - 1), (f = 0 <= h - 1 ? h - 1 : j.length - 1));
      n = c.slice(0, g);
      m = c.slice(g);
      q = j.slice(h);
      l = j.slice(0, h);
        ...
        if (g.time <= l) {
          if (j < l)
            if (this.loop) {
              ...
              for (g = this.getNextKeyWith(c, n, 1); g.time < j; ) (h = g), (g = this.getNextKeyWith(c, n, g.index + 1));
            } else {
              this.stop();
              return;
            }
          ...
          if (((c = a.position), this.interpolationType === THREE.AnimationHandler.LINEAR)) (c.x = e[0] + (f[0] - e[0]) * d), (c.y = e[1] + (f[1] - e[1]) * d), (c.z = e[2] + (f[2] - e[2]) * d);
            ...
            if (this.interpolationType === THREE.AnimationHandler.CATMULLROM || this.interpolationType === THREE.AnimationHandler.CATMULLROM_FORWARD)
              (this.points[0] = this.getPrevKeyWith("pos", n, h.index - 1).pos),
                (this.points[1] = e),
                (this.points[2] = f),
                (this.points[3] = this.getNextKeyWith("pos", n, g.index + 1).pos),
                (d = 0.33 * d + 0.33),
  ...
  if (!this.isPlaying) {
    ...
    for (c = 0; c < d; c++)
      (e = this.hierarchy[c]),
        ...
        (e.useQuaternion = !0),
        void 0 === f.animationCache && ((f.animationCache = {}), (f.animationCache.prevKey = null), (f.animationCache.nextKey = null), (f.animationCache.originalMatrix = e instanceof THREE.Bone ? e.skinMatrix : e.matrix)),
  ...
  if (this.isPlaying) {
    ...
    if ((i = h < g) && !this.loop) {
      for (var a = 0, j = this.hierarchy.length; a < j; a++) {
        ...
        e = this.hierarchy[a];
        if (l.length) {
          for (l = 0; l < f.length; l++) (h = f[l]), (g = this.getPrevKeyWith(h, a, d)) && g.apply(h);
          this.data.hierarchy[a].node.updateMatrix();
        ...
        if (this.JITCompile && void 0 !== f[a][e]) d instanceof THREE.Bone ? ((d.skinMatrix = f[a][e]), (d.matrixWorldNeedsUpdate = !1)) : ((d.matrix = f[a][e]), (d.matrixWorldNeedsUpdate = !0));
          ...
          if (b && c) {
            if (c.time <= g) {
              ...
              } else if (!i) for (var m = l.length - 1; c.time < h && c.index !== m; ) (b = c), (c = l[b.index + 1]);
              n.prevKey = b;
              n.nextKey = c;
            }
...
THREE.CubeGeometry = function (a, b, c, d, e, f) {
  function h(a, b, c, d, e, f, h, r) {
    var p,
      ...
      G = f / 2,
      H = g.vertices.length;
    if (("x" === a && "y" === b) || ("y" === a && "x" === b)) p = "z";
    else if (("x" === a && "z" === b) || ("z" === a && "x" === b)) (p = "y"), (v = g.depthSegments);
    else if (("z" === a && "y" === b) || ("y" === a && "z" === b)) (p = "x"), (s = g.depthSegments);
    var I = s + 1,
      F = v + 1,
      A = e / s,
      B = f / v,
    ...
    for (e = 0; e < v; e++)
      for (f = 0; f < s; f++)
        (a = new THREE.Face4(f + I * e + H, f + I * (e + 1) + H, f + 1 + I * (e + 1) + H, f + 1 + I * e + H)),
          a.normal.copy(L),
          a.vertexNormals.push(L.clone(), L.clone(), L.clone(), L.clone()),
          (a.materialIndex = r),
          g.faces.push(a),
          g.faceVertexUvs[0].push([new THREE.Vector2(f / s, 1 - e / v), new THREE.Vector2(f / s, 1 - (e + 1) / v), new THREE.Vector2((f + 1) / s, 1 - (e + 1) / v), new THREE.Vector2((f + 1) / s, 1 - e / v)]);
  }
  THREE.Geometry.call(this);
  var g = this;
  this.width = a;
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
  ...
  for (i = 0; i <= e; i++) {
    ...
    for (g = 0; g <= d; g++) {
      var r = g / d,
        p = new THREE.Vector3();
      p.x = t * Math.sin(2 * r * Math.PI);
      p.y = -q * c + h;
      p.z = t * Math.cos(2 * r * Math.PI);
      this.vertices.push(p);
      n.push(this.vertices.length - 1);
      m.push(new THREE.Vector2(r, 1 - q));
    }
    j.push(n);
    l.push(m);
  }
  c = (b - a) / c;
  for (g = 0; g < d; g++) {
    0 !== a ? ((n = this.vertices[j[0][g]].clone()), (m = this.vertices[j[0][g + 1]].clone())) : ((n = this.vertices[j[1][g]].clone()), (m = this.vertices[j[1][g + 1]].clone()));
    ...
    for (i = 0; i < e; i++) {
      var q = j[i][g],
        ...
        F = l[i + 1][g + 1].clone(),
        A = l[i][g + 1].clone();
      this.faces.push(new THREE.Face4(q, t, r, p, [s, v, y, G]));
      this.faceVertexUvs[0].push([H, I, F, A]);
    }
  }
  if (!1 === f && 0 < a) {
    ...
    for (g = 0; g < d; g++)
      (q = j[0][g]),
        ...
        (H = l[0][g].clone()),
        (I = l[0][g + 1].clone()),
        (F = new THREE.Vector2(I.u, 0)),
        this.faces.push(new THREE.Face3(q, t, r, [s, v, y])),
        this.faceVertexUvs[0].push([H, I, F]);
  }
  if (!1 === f && 0 < b) {
    this.vertices.push(new THREE.Vector3(0, -h, 0));
    for (g = 0; g < d; g++)
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    for (O = c.length; 0 <= --O; ) {
      ...
      for (var g = 0, h = q + 2 * l, g = 0; g < h; g++) {
        var i = oa * g,
          ...
          m = m + J,
          j = j + J;
        C.faces.push(new THREE.Face4(n, i, m, j, null, null, v));
        n = y.generateSideWallUV(C, a, p, b, n, i, m, j, s, r, t, w);
  ...
  function h(c, d, e, f) {
    ...
    c = f ? y.generateBottomUV(C, a, b, c, d, e) : y.generateTopUV(C, a, b, c, d, e);
  ...
  var g = void 0 !== b.amount ? b.amount : 100,
    ...
    I,
    F;
  t && ((r = t.getSpacedPoints(q)), (p = !0), (n = !1), (G = void 0 !== b.frames ? b.frames : new THREE.TubeGeometry.FrenetFrames(t, q, !1)), (H = new THREE.Vector3()), (I = new THREE.Vector3()), (F = new THREE.Vector3()));
  n || (j = i = l = 0);
  var A,
    B,
    L,
  ...
  if ((t = !THREE.Shape.Utils.isClockWise(N))) {
    N = N.reverse();
    B = 0;
    for (L = m.length; B < L; B++) (A = m[B]), THREE.Shape.Utils.isClockWise(A) && (m[B] = A.reverse());
    t = !1;
  }
  var z = THREE.Shape.Utils.triangulateShape(N, m),
    t = N;
  B = 0;
  for (L = m.length; B < L; B++) (A = m[B]), (N = N.concat(A));
  var M,
    w,
    Z,
    K,
    ...
    qa = t.length;
  M = qa - 1;
  for (w = O + 1; O < qa; O++, M++, w++) M === qa && (M = 0), w === qa && (w = 0), (Va[O] = d(t[O], t[M], t[w]));
  var Fa = [],
    wa,
    D = Va.concat();
  B = 0;
  for (L = m.length; B < L; B++) {
    ...
    qa = A.length;
    M = qa - 1;
    for (w = O + 1; O < qa; O++, M++, w++) M === qa && (M = 0), w === qa && (w = 0), (wa[O] = d(A[O], A[M], A[w]));
    Fa.push(wa);
    D = D.concat(wa);
  }
  for (M = 0; M < l; M++) {
    A = M / l;
    Z = i * (1 - A);
    w = j * Math.sin((A * Math.PI) / 2);
    O = 0;
    for (qa = t.length; O < qa; O++) (K = c(t[O], Va[O], w)), f(K.x, K.y, -Z);
    B = 0;
    for (L = m.length; B < L; B++) {
      A = m[B];
      wa = Fa[B];
      O = 0;
      for (qa = A.length; O < qa; O++) (K = c(A[O], wa[O], w)), f(K.x, K.y, -Z);
    }
  }
  w = j;
  for (O = 0; O < oa; O++) (K = n ? c(N[O], D[O], w) : N[O]), p ? (I.copy(G.normals[0]).multiplyScalar(K.x), H.copy(G.binormals[0]).multiplyScalar(K.y), F.copy(r[0]).add(I).add(H), f(F.x, F.y, F.z)) : f(K.x, K.y, 0);
  for (A = 1; A <= q; A++) for (O = 0; O < oa; O++) (K = n ? c(N[O], D[O], w) : N[O]), p ? (I.copy(G.normals[A]).multiplyScalar(K.x), H.copy(G.binormals[A]).multiplyScalar(K.y), F.copy(r[A]).add(I).add(H), f(F.x, F.y, F.z)) : f(K.x, K.y, (g / q) * A);
  for (M = l - 1; 0 <= M; M--) {
    A = M / l;
    Z = i * (1 - A);
    w = j * Math.sin((A * Math.PI) / 2);
    O = 0;
    for (qa = t.length; O < qa; O++) (K = c(t[O], Va[O], w)), f(K.x, K.y, g + Z);
    B = 0;
    for (L = m.length; B < L; B++) {
      A = m[B];
      wa = Fa[B];
      O = 0;
      for (qa = A.length; O < qa; O++) (K = c(A[O], wa[O], w)), p ? f(K.x, K.y + r[q - 1].y, r[q - 1].x + Z) : f(K.x, K.y, g + Z);
    }
  }
  if (n) {
    i = 0 * oa;
    for (O = 0; O < Pa; O++) (g = z[O]), h(g[2] + i, g[1] + i, g[0] + i, !0);
    i = oa * (q + 2 * l);
    for (O = 0; O < Pa; O++) (g = z[O]), h(g[0] + i, g[1] + i, g[2] + i, !1);
  } else {
    for (O = 0; O < Pa; O++) (g = z[O]), h(g[2], g[1], g[0], !0);
    for (O = 0; O < Pa; O++) (g = z[O]), h(g[0] + oa * q, g[1] + oa * q, g[2] + oa * q, !1);
  }
  g = 0;
  e(t, g);
  g += t.length;
  B = 0;
  for (L = m.length; B < L; B++) (A = m[B]), e(A, g), (g += A.length);
};
THREE.ExtrudeGeometry.WorldUVGenerator = {
  ...
  generateSideWallUV: function (a, b, c, d, e, f, h, g) {
    var b = a.vertices[e].x,
      ...
      m = a.vertices[g].y,
      a = a.vertices[g].z;
    return 0.01 > Math.abs(c - i) ? [new THREE.Vector2(b, 1 - e), new THREE.Vector2(d, 1 - f), new THREE.Vector2(j, 1 - h), new THREE.Vector2(n, 1 - a)] : [new THREE.Vector2(c, 1 - e), new THREE.Vector2(i, 1 - f), new THREE.Vector2(l, 1 - h), new THREE.Vector2(m, 1 - a)];
  },
};
...
THREE.LatheGeometry = function (a, b, c, d) {
  ...
  for (var b = b || 12, c = c || 0, d = d || 2 * Math.PI, e = 1 / (a.length - 1), f = 1 / b, h = 0, g = b; h <= g; h++)
    for (var i = c + h * f * d, j = Math.cos(i), l = Math.sin(i), i = 0, n = a.length; i < n; i++) {
      var m = a[i],
        q = new THREE.Vector3();
      q.x = j * m.x - l * m.y;
      q.y = l * m.x + j * m.y;
  ...
  for (g = b; h < g; h++) {
    ...
    for (n = a.length - 1; i < n; i++)
      (d = b = i + c * h), (l = b + c), (j = b + 1 + c), this.faces.push(new THREE.Face4(d, l, j, b + 1)), (j = h * f), (b = i * e), (d = j + f), (l = b + e), this.faceVertexUvs[0].push([new THREE.Vector2(j, b), new THREE.Vector2(d, b), new THREE.Vector2(d, l), new THREE.Vector2(j, l)]);
  }
  this.mergeVertices();
  this.computeCentroids();
  this.computeFaceNormals();
...
THREE.PlaneGeometry = function (a, b, c, d) {
  ...
  for (a = 0; a < f; a++)
    for (b = 0; b < d; b++)
      (c = new THREE.Face4(b + h * a, b + h * (a + 1), b + 1 + h * (a + 1), b + 1 + h * a)),
        c.normal.copy(l),
  ...
  for (i = 0; i <= c; i++) {
    ...
    for (g = 0; g <= b; g++) {
      var q = g / b,
        t = i / c,
        r = new THREE.Vector3();
      r.x = -a * Math.cos(d + q * e) * Math.sin(f + t * h);
      r.y = a * Math.cos(f + t * h);
      r.z = a * Math.sin(d + q * e) * Math.sin(f + t * h);
  ...
  for (i = 0; i < this.heightSegments; i++)
    for (g = 0; g < this.widthSegments; g++) {
      ...
      Math.abs(this.vertices[b].y) === this.radius
        ? (this.faces.push(new THREE.Face3(b, d, e, [f, n, m])), this.faceVertexUvs[0].push([q, r, p]))
        : Math.abs(this.vertices[d].y) === this.radius
        ? (this.faces.push(new THREE.Face3(b, c, d, [f, h, n])), this.faceVertexUvs[0].push([q, t, r]))
        : (this.faces.push(new THREE.Face4(b, c, d, e, [f, h, n, m])), this.faceVertexUvs[0].push([q, t, r, p]));
    }
  this.computeCentroids();
  this.computeFaceNormals();
  this.boundingSphere = new THREE.Sphere(new THREE.Vector3(), a);
  ...
  for (a = 0; a < this.radialSegments; ++a) {
    ...
    for (b = 0; b < this.tubularSegments; ++b) {
      var i = 2 * (a / this.radialSegments) * this.p * Math.PI,
        h = 2 * (b / this.tubularSegments) * Math.PI,
        f = g(i, h, this.q, this.p, this.radius, this.heightScale),
        i = g(i + 0.01, h, this.q, this.p, this.radius, this.heightScale);
      c.subVectors(i, f);
      d.addVectors(i, f);
      e.crossVectors(c, d);
      d.crossVectors(e, c);
...
THREE.TubeGeometry = function (a, b, c, d, e, f) {
  ...
  for (b = 0; b < e; b++) {
    ...
    h = m[b];
    g = q[b];
    this.debug && (this.debug.add(new THREE.ArrowHelper(d, l, c, 255)), this.debug.add(new THREE.ArrowHelper(h, l, c, 16711680)), this.debug.add(new THREE.ArrowHelper(g, l, c, 65280)));
    for (d = 0; d < this.radiusSegments; d++)
      (i = 2 * (d / this.radiusSegments) * Math.PI), (j = -this.radius * Math.cos(i)), (i = this.radius * Math.sin(i)), f.copy(l), (f.x += j * h.x + i * g.x), (f.y += j * h.y + i * g.y), (f.z += j * h.z + i * g.z), (this.grid[b][d] = this.vertices.push(new THREE.Vector3(f.x, f.y, f.z)) - 1);
  }
  for (b = 0; b < this.segments; b++)
    for (d = 0; d < this.radiusSegments; d++)
      (e = this.closed ? (b + 1) % this.segments : b + 1),
        ...
        (e = this.grid[e][f]),
        (f = this.grid[b][f]),
        (n = new THREE.Vector2(b / this.segments, d / this.radiusSegments)),
        (m = new THREE.Vector2((b + 1) / this.segments, d / this.radiusSegments)),
        (q = new THREE.Vector2((b + 1) / this.segments, (d + 1) / this.radiusSegments)),
        (h = new THREE.Vector2(b / this.segments, (d + 1) / this.radiusSegments)),
        this.faces.push(new THREE.Face4(a, c, e, f)),
        this.faceVertexUvs[0].push([n, m, q, h]);
  this.computeCentroids();
  this.computeFaceNormals();
  this.computeVertexNormals();
};
...
THREE.TubeGeometry.FrenetFrames = function (a, b, c) {
  ...
  for (j = 1; j < b; j++) (f[j] = f[j - 1].clone()), (h[j] = h[j - 1].clone()), g.crossVectors(e[j - 1], e[j]), 1e-4 < g.length() && (g.normalize(), (d = Math.acos(e[j - 1].dot(e[j]))), f[j].applyMatrix4(i.makeRotationAxis(g, d))), h[j].crossVectors(e[j], f[j]);
  if (c) {
    d = Math.acos(f[0].dot(f[b - 1]));
    d /= b - 1;
    0 < e[0].dot(g.crossVectors(f[0], f[b - 1])) && (d = -d);
    for (j = 1; j < b; j++) f[j].applyMatrix4(i.makeRotationAxis(e[j], d * j)), h[j].crossVectors(e[j], f[j]);
  }
};
THREE.PolyhedronGeometry = function (a, b, c, d) {
  ...
  for (var l = this.vertices, a = [], i = 0, j = b.length; i < j; i++) {
    var n = l[b[i][0]],
      m = l[b[i][1]],
      q = l[b[i][2]];
    a[i] = new THREE.Face3(n.index, m.index, q.index, [n.clone(), m.clone(), q.clone()]);
  }
  i = 0;
  for (j = a.length; i < j; i++) {
    ...
    b = Math.pow(2, l);
    Math.pow(4, l);
    for (var l = e(g.vertices[m.a]), n = e(g.vertices[m.b]), t = e(g.vertices[m.c]), m = [], q = 0; q <= b; q++) {
      m[q] = [];
      for (var r = e(l.clone().lerp(t, q / b)), p = e(n.clone().lerp(t, q / b)), s = b - q, v = 0; v <= s; v++) m[q][v] = 0 == v && q == b ? r : e(r.clone().lerp(p, v / s));
    }
    for (q = 0; q < b; q++) for (v = 0; v < 2 * (b - q) - 1; v++) (l = Math.floor(v / 2)), 0 == v % 2 ? f(m[q][l + 1], m[q + 1][l], m[q][l]) : f(m[q][l + 1], m[q + 1][l + 1], m[q + 1][l]);
  }
  i = 0;
  for (j = this.faceVertexUvs[0].length; i < j; i++) (d = this.faceVertexUvs[0][i]), (a = d[0].x), (b = d[1].x), (l = d[2].x), (n = Math.max(a, Math.max(b, l))), (m = Math.min(a, Math.min(b, l))), 0.9 < n && 0.1 > m && (0.2 > a && (d[0].x += 1), 0.2 > b && (d[1].x += 1), 0.2 > l && (d[2].x += 1));
  i = 0;
  ...
  for (g = 0; g < c; g++)
    for (i = 0; i < b; i++)
      (a = g * n + i),
        ...
        (r = new THREE.Vector2((i + 1) / b, (g + 1) / c)),
        d ? (f.push(new THREE.Face3(a, e, l)), f.push(new THREE.Face3(e, j, l)), h.push([m, q, t]), h.push([q, r, t])) : (f.push(new THREE.Face4(a, e, j, l)), h.push([m, q, r, t]));
  this.computeCentroids();
  this.computeFaceNormals();
  this.computeVertexNormals();
};
...
THREE.ConvexGeometry = function (a) {
  ...
  for (d = 0; d < c.length; d++) {
    h = c[d];
    for (g = 0; 3 > g; g++) void 0 === f[h[g]] && ((f[h[g]] = e++), this.vertices.push(a[h[g]])), (h[g] = f[h[g]]);
  }
  for (d = 0; d < c.length; d++) this.faces.push(new THREE.Face3(c[d][0], c[d][1], c[d][2]));
  for (d = 0; d < this.faces.length; d++) (h = this.faces[d]), this.faceVertexUvs[0].push([b(this.vertices[h.a]), b(this.vertices[h.b]), b(this.vertices[h.c])]);
  this.computeCentroids();
  this.computeFaceNormals();
  this.computeVertexNormals();
};
...
THREE.FaceNormalsHelper = function (a, b) {
  for (var b = b || 20, c = new THREE.Geometry(), d = 0, e = a.geometry.faces.length; d < e; d++) {
    var f = a.geometry.faces[d];
    c.vertices.push(f.centroid);
    c.vertices.push(f.normal.clone().multiplyScalar(b).add(f.centroid));
  }
  THREE.Line.call(this, c, new THREE.LineBasicMaterial({ color: 255 }), THREE.LinePieces);
  this.matrixAutoUpdate = !1;
  this.matrixWorld = a.matrixWorld;
};
THREE.FaceNormalsHelper.prototype = Object.create(THREE.Line.prototype);
THREE.GridHelper = function (a, b) {
  for (var c = new THREE.Geometry(), d = new THREE.LineBasicMaterial({ vertexColors: THREE.VertexColors }), e = new THREE.Color(4473924), f = new THREE.Color(8947848), h = -a; h <= a; h += b) {
    c.vertices.push(new THREE.Vector3(-a, 0, h), new THREE.Vector3(a, 0, h), new THREE.Vector3(h, 0, -a), new THREE.Vector3(h, 0, a));
    var g = 0 === h ? e : f;
...
THREE.LensFlarePlugin = function () {
  ...
  this.init = function (t) {
    ...
    b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAG_FILTER, b.NEAREST);
    b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, b.NEAREST);
    0 >= b.getParameter(b.MAX_VERTEX_TEXTURE_IMAGE_UNITS) ? ((l = !1), (n = a(THREE.ShaderFlares.lensFlare, d))) : ((l = !0), (n = a(THREE.ShaderFlares.lensFlareVertexTexture, d)));
    m = {};
    q = {};
          ...
          for (z = M.lensFlares.length; N < z; N++)
            (w = M.lensFlares[N]),
              0.001 < w.opacity &&
                ...
                b.uniform3f(C.screenPosition, B.x, B.y, B.z),
                b.uniform2f(C.scale, A.x, A.y),
                b.uniform1f(C.rotation, w.rotation),
                b.uniform1f(C.opacity, w.opacity),
                b.uniform3f(C.color, w.color.r, w.color.g, w.color.b),
...
THREE.ShadowMapPlugin = function () {
  ...
  this.update = function (n, m) {
    ...
    for (t = n.__lights.length; q < t; q++)
      if (((r = n.__lights[q]), r.castShadow))
        if (r instanceof THREE.DirectionalLight && r.shadowCascade)
          for (s = 0; s < r.shadowCascadeCount; s++) {
            var F;
            if (r.shadowCascadeArray[s]) F = r.shadowCascadeArray[s];
            else {
              H = r;
              y = s;
              ...
              F.onlyShadow = !0;
              F.castShadow = !0;
              F.shadowCameraNear = H.shadowCameraNear;
              F.shadowCameraFar = H.shadowCameraFar;
              F.shadowCameraLeft = H.shadowCameraLeft;
              F.shadowCameraRight = H.shadowCameraRight;
              F.shadowCameraBottom = H.shadowCameraBottom;
              F.shadowCameraTop = H.shadowCameraTop;
              F.shadowCameraVisible = H.shadowCameraVisible;
              F.shadowDarkness = H.shadowDarkness;
              F.shadowBias = H.shadowCascadeBias[y];
              F.shadowMapWidth = H.shadowCascadeWidth[y];
              F.shadowMapHeight = H.shadowCascadeHeight[y];
              F.pointsWorld = [];
              F.pointsFrustum = [];
              G = F.pointsWorld;
              v = F.pointsFrustum;
              for (var A = 0; 8 > A; A++) (G[A] = new THREE.Vector3()), (v[A] = new THREE.Vector3());
              G = H.shadowCascadeNearZ[y];
              H = H.shadowCascadeFarZ[y];
              v[0].set(-1, -1, G);
              v[1].set(1, -1, G);
              v[2].set(-1, 1, G);
              v[3].set(1, 1, G);
              ...
              v.position = r.shadowCascadeOffset;
              v.add(F);
              v.add(F.target);
              m.add(v);
              r.shadowCascadeArray[s] = F;
              console.log("Created virtualLight", F);
            }
            y = r;
            G = s;
            H = y.shadowCascadeArray[G];
            H.position.copy(y.position);
            H.target.position.copy(y.target.position);
            H.lookAt(H.target);
            H.shadowCameraVisible = y.shadowCameraVisible;
            H.shadowDarkness = y.shadowDarkness;
            H.shadowBias = y.shadowCascadeBias[G];
            v = y.shadowCascadeNearZ[G];
            y = y.shadowCascadeFarZ[G];
            H = H.pointsFrustum;
            H[0].z = v;
            H[1].z = v;
            H[2].z = v;
    ...
    q = 0;
    for (t = I.length; q < t; q++) {
      r = I[q];
      r.shadowMap ||
        ((s = THREE.LinearFilter),
        b.shadowMapType === THREE.PCFSoftShadowMap && (s = THREE.NearestFilter),
        (r.shadowMap = new THREE.WebGLRenderTarget(r.shadowMapWidth, r.shadowMapHeight, { minFilter: s, magFilter: s, format: THREE.RGBAFormat })),
      ...
      if (r.isVirtual && F.originalCamera == m) {
        s = m;
        p = r.shadowCamera;
        v = r.pointsFrustum;
        H = r.pointsWorld;
        ...
        for (y = 0; 8 > y; y++) (G = H[y]), G.copy(v[y]), THREE.ShadowMapPlugin.__projector.unprojectVector(G, s), G.applyMatrix4(p.matrixWorldInverse), G.x < i.x && (i.x = G.x), G.x > j.x && (j.x = G.x), G.y < i.y && (i.y = G.y), G.y > j.y && (j.y = G.y), G.z < i.z && (i.z = G.z), G.z > j.z && (j.z = G.z);
        p.left = i.x;
        p.right = j.x;
        p.top = j.y;
        p.bottom = i.y;
      ...
      v = r.shadowMatrix;
      s = r.shadowCamera;
      s.position.getPositionFromMatrix(r.matrixWorld);
      l.getPositionFromMatrix(r.target.matrixWorld);
      s.lookAt(l);
      s.updateMatrixWorld();
      ...
      H = n.__webglObjects;
      r = 0;
      for (p = H.length; r < p; r++) if (((y = H[r]), (v = y.object), (y.render = !1), v.visible && v.castShadow && (!(v instanceof THREE.Mesh || v instanceof THREE.ParticleSystem) || !v.frustumCulled || h.intersectsObject(v)))) v._modelViewMatrix.multiplyMatrices(s.matrixWorldInverse, v.matrixWorld), (y.render = !0);
      r = 0;
      for (p = H.length; r < p; r++)
        (y = H[r]),
          y.render &&
            ((v = y.object),
            (y = y.buffer),
            (A = v.material instanceof THREE.MeshFaceMaterial ? v.material.materials[0] : v.material),
            (G = 0 < v.geometry.morphTargets.length && A.morphTargets),
            (A = v instanceof THREE.SkinnedMesh && A.skinning),
            (G = v.customDepthMaterial ? v.customDepthMaterial : A ? (G ? f : e) : G ? d : c),
            y instanceof THREE.BufferGeometry ? b.renderBufferDirect(s, n.__lights, null, G, y, v) : b.renderBuffer(s, n.__lights, null, G, y, v));
      H = n.__webglObjectsImmediate;
      r = 0;
      for (p = H.length; r < p; r++) (y = H[r]), (v = y.object), v.visible && v.castShadow && (v._modelViewMatrix.multiplyMatrices(s.matrixWorldInverse, v.matrixWorld), b.renderImmediateObject(s, n.__lights, null, c, v));
    }
    q = b.getClearColor();
    t = b.getClearAlpha();
...
THREE.SpritePlugin = function () {
  ...
  this.init = function (a) {
    ...
    var a = THREE.ShaderSprite.sprite,
      ...
      r = "precision " + d + " float;\n";
    b.shaderSource(q, r + a.fragmentShader);
    b.shaderSource(t, r + a.vertexShader);
    b.compileShader(q);
    b.compileShader(t);
    b.attachShader(m, q);
    b.attachShader(m, t);
  ...
  this.render = function (d, e, f, t) {
    ...
    if (p) {
      ...
      var H = (s = 0),
        I = d.fog;
      I
        ? (b.uniform3f(v.fogColor, I.color.r, I.color.g, I.color.b), I instanceof THREE.Fog ? (b.uniform1f(v.fogNear, I.near), b.uniform1f(v.fogFar, I.far), b.uniform1i(v.fogType, 1), (H = s = 1)) : I instanceof THREE.FogExp2 && (b.uniform1f(v.fogDensity, I.density), b.uniform1i(v.fogType, 2), (H = s = 2)))
        : (b.uniform1i(v.fogType, 0), (H = s = 0));
      for (var F, A, B = [], I = 0; I < p; I++) (F = r[I]), (A = F.material), F.visible && 0 !== A.opacity && (A.useScreenCoordinates ? (F.z = -F.position.z) : (F._modelViewMatrix.multiplyMatrices(e.matrixWorldInverse, F.matrixWorld), (F.z = -F._modelViewMatrix.elements[14])));
      r.sort(a);
      for (I = 0; I < p; I++)
        (F = r[I]),
          (A = F.material),
          F.visible &&
            ...
            A.map.image &&
            A.map.image.width &&
            (b.uniform1f(v.alphaTest, A.alphaTest),
            !0 === A.useScreenCoordinates
              ? (b.uniform1i(v.useScreenCoordinates, 1), b.uniform3f(v.screenPosition, (F.position.x * c.devicePixelRatio - f) / f, (G - F.position.y * c.devicePixelRatio) / G, Math.max(0, Math.min(1, F.position.z))), (B[0] = c.devicePixelRatio), (B[1] = c.devicePixelRatio))
              : (b.uniform1i(v.useScreenCoordinates, 0), b.uniform1i(v.sizeAttenuation, A.sizeAttenuation ? 1 : 0), b.uniformMatrix4fv(v.modelViewMatrix, !1, F._modelViewMatrix.elements), (B[0] = 1), (B[1] = 1)),
            (e = d.fog && A.fog ? H : 0),
            s !== e && (b.uniform1i(v.fogType, e), (s = e)),
            (e = 1 / (A.scaleByViewport ? t : 1)),
            (B[0] *= e * y * F.scale.x),
            (B[1] *= e * F.scale.y),
            b.uniform2f(v.uvScale, A.uvScale.x, A.uvScale.y),
            b.uniform2f(v.uvOffset, A.uvOffset.x, A.uvOffset.y),
            b.uniform2f(v.alignment, A.alignment.x, A.alignment.y),
            b.uniform1f(v.opacity, A.opacity),
            b.uniform3f(v.color, A.color.r, A.color.g, A.color.b),
            b.uniform1f(v.rotation, F.rotation),
            b.uniform2fv(v.scale, B),
...
THREE.DepthPassPlugin = function () {
  ...
  this.update = function (i, j) {
    ...
    r = i.__webglObjects;
    l = 0;
    for (n = r.length; l < n; l++) if (((m = r[l]), (t = m.object), (m.render = !1), t.visible && (!(t instanceof THREE.Mesh || t instanceof THREE.ParticleSystem) || !t.frustumCulled || h.intersectsObject(t)))) t._modelViewMatrix.multiplyMatrices(j.matrixWorldInverse, t.matrixWorld), (m.render = !0);
    var p;
    l = 0;
    for (n = r.length; l < n; l++)
      if (((m = r[l]), m.render && ((t = m.object), (m = m.buffer), !(t instanceof THREE.ParticleSystem) || t.customDepthMaterial)))
        (p = t.material instanceof THREE.MeshFaceMaterial ? t.material.materials[0] : t.material) && b.setMaterialFaces(t.material),
          (q = 0 < t.geometry.morphTargets.length && p.morphTargets),
          (p = t instanceof THREE.SkinnedMesh && p.skinning),
          (q = t.customDepthMaterial ? t.customDepthMaterial : p ? (q ? f : e) : q ? d : c),
          m instanceof THREE.BufferGeometry ? b.renderBufferDirect(j, i.__lights, null, q, m, t) : b.renderBuffer(j, i.__lights, null, q, m, t);
    r = i.__webglObjectsImmediate;
    l = 0;
    for (n = r.length; l < n; l++) (m = r[l]), (t = m.object), t.visible && (t._modelViewMatrix.multiplyMatrices(j.matrixWorldInverse, t.matrixWorld), b.renderImmediateObject(j, i.__lights, null, c, t));
    l = b.getClearColor();
    n = b.getClearAlpha();
